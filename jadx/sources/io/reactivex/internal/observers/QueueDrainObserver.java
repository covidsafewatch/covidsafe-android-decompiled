...
public abstract class QueueDrainObserver<T, U, V>
  ...
  public QueueDrainObserver(Observer<? super V> observer,
                            SimplePlainQueue<U> simplePlainQueue) {
    this.downstream = observer;
    this.queue = simplePlainQueue;
  }

  public final boolean cancelled() { return this.cancelled; }

  public final boolean done() { return this.done; }

  public final boolean enter() { return this.wip.getAndIncrement() == 0; }
  ...
  public final Throwable error() { return this.error; }

  public final int leave(int i) { return this.wip.addAndGet(i); }
}
