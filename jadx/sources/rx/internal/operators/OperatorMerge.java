...
public final class OperatorMerge<T>
  ...
  static final class HolderNoDelay {
    static final OperatorMerge<Object> INSTANCE =
        new OperatorMerge<>(false, Integer.MAX_VALUE);
  ...
  static final class HolderDelayErrors {
    static final OperatorMerge<Object> INSTANCE =
        new OperatorMerge<>(true, Integer.MAX_VALUE);
  ...
  public static <T> OperatorMerge<T> instance(boolean z, int i) {
    if (i <= 0) {
      throw new IllegalArgumentException(
          "maxConcurrent > 0 required but it was " + i);
  ...
  public Subscriber<Observable<? extends T>>
  call(Subscriber<? super T> subscriber) {
    MergeSubscriber mergeSubscriber =
        new MergeSubscriber(subscriber, this.delayErrors, this.maxConcurrent);
  ...
  static final class MergeProducer<T> extends AtomicLong implements Producer {
    ...
    public long produced(int i) { return addAndGet((long)(-i)); }
  }
  ...
  static final class MergeSubscriber<T>
    ...
    private void reportError() {
      ...
      if (arrayList.size() == 1) {
        ...
        this.child.onError(
            new CompositeException((Collection<? extends Throwable>)arrayList));
      }
    }
    ...
    public void removeInner(InnerSubscriber<T> innerSubscriber) {
      ...
      synchronized (this.innerGuard) {
        ...
        if (i >= 0) {
          ...
          System.arraycopy(innerSubscriberArr, i + 1, innerSubscriberArr2, i,
                           (length - i) - 1);
          this.innerSubscribers = innerSubscriberArr2;
        }
      }
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
       ...
       jadx.core.dex.visitors.regions.RegionMaker.makeRegion(RegionMaker.java:86)
            at
       jadx.core.dex.visitors.regions.RegionMaker.processIf(RegionMaker.java:693)
            at
       jadx.core.dex.visitors.regions.RegionMaker.traverse(RegionMaker.java:123)
            at
       jadx.core.dex.visitors.regions.RegionMaker.makeRegion(RegionMaker.java:86)
            at
       jadx.core.dex.visitors.regions.RegionMaker.processHandlersOutBlocks(RegionMaker.java:1008)
            at
       jadx.core.dex.visitors.regions.RegionMaker.processTryCatchBlocks(RegionMaker.java:978)
            at
       jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:52)
        */
    protected void
    emitScalar(rx.internal.operators.OperatorMerge.InnerSubscriber<T> r5, T r6,
               long r7) {
      /*
          r4 = this;
          r0 = 1
      ...
      } r5.unsubscribe()     // Catch:{ all -> 0x0017 } r5.onError(r6)     //
      Catch:{ all -> 0x0017 } return L_0x0017: r5 = move-exception goto L_0x0048
      L_0x0019:
          java.util.Queue r2 = r4.getOrCreateErrorQueue()     // Catch:{ all ->
      0x0046 } r2.offer(r6)     // Catch:{ all -> 0x0046 } L_0x0020: r2 =
      9223372036854775807(0x7fffffffffffffff, double:NaN) int r6 = (r7 > r2 ? 1
      : (r7 == r2 ? 0 : -1)) if (r6 == 0) goto L_0x002e
          rx.internal.operators.OperatorMerge$MergeProducer<T> r6 = r4.producer
      // Catch:{ all -> 0x0046 } r6.produced(r0)     // Catch:{ all -> 0x0046 }
      L_0x002e:
          r6 = 1
      ...
      */
      throw new UnsupportedOperationException(
          "Method not decompiled: rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(rx.internal.operators.OperatorMerge$InnerSubscriber, java.lang.Object, long):void");
    }

    public void requestMore(long j) { request(j); }
    ...
    public void queueScalar(T t) {
      ...
      if (!queue3.offer(NotificationLite.next(t))) {
        unsubscribe();
        onError(OnErrorThrowable.addValueAsLastCause(
            new MissingBackpressureException(), t));
      }
    }
    ...
    protected void emitScalar(T r5, long r6) {
      ...
      } r4.unsubscribe()     // Catch:{ all -> 0x0017 } r4.onError(r5)     //
      Catch:{ all -> 0x0017 } return L_0x0017: r5 = move-exception goto L_0x0053
      L_0x0019:
          java.util.Queue r2 = r4.getOrCreateErrorQueue()     // Catch:{ all ->
      0x0051 } r2.offer(r5)     // Catch:{ all -> 0x0051 } L_0x0020: r2 =
      9223372036854775807(0x7fffffffffffffff, double:NaN) int r5 = (r6 > r2 ? 1
      : (r6 == r2 ? 0 : -1)) if (r5 == 0) goto L_0x002e
          rx.internal.operators.OperatorMerge$MergeProducer<T> r5 = r4.producer
      // Catch:{ all -> 0x0051 } r5.produced(r0)     // Catch:{ all -> 0x0051 }
      L_0x002e:
      ...
      */
      throw new UnsupportedOperationException(
          "Method not decompiled: rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(java.lang.Object, long):void");
    }
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:162:0x0193, code
       lost: r0 = th;
     */
    ...
    public void emitLoop() {
      ...
      L_0x0005:
          ...
          return
      L_0x000c:
          java.util.Queue<java.lang.Object> r5 = r1.queue     // Catch:{ all ->
      0x0197 } rx.internal.operators.OperatorMerge$MergeProducer<T> r0 =
      r1.producer     // Catch:{ all -> 0x0197 } long r6 = r0.get()     //
      Catch:{ all -> 0x0197 } r8 = 9223372036854775807(0x7fffffffffffffff,
      double:NaN) int r0 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1)) if (r0 != 0) goto
      L_0x001f r10 = 1 goto L_0x0020 L_0x001f: r10 = r3 L_0x0020: r11 = 1 r14 =
      0 if (r5 == 0) goto L_0x0089 r0 = r3 L_0x0027: r16 = r6 r6 = r0 r7 = r3 r0
      = 0 L_0x002c: int r18 = (r16 > r14 ? 1 : (r16 == r14 ? 0 : -1)) if (r18 <=
      0) goto L_0x0071 java.lang.Object r18 = r5.poll()     // Catch:{ all ->
      0x0197 } boolean r0 = r22.checkTerminate()     // Catch:{ all -> 0x0197 }
      ...
      L_0x0040:
          java.lang.Object r0 =
      rx.internal.operators.NotificationLite.getValue(r18)     // Catch:{ all ->
      0x0197 } r4.onNext(r0)     // Catch:{ all -> 0x0048 } goto L_0x0068
      L_0x0048:
          r0 = move-exception
          r19 = r0
          boolean r0 = r1.delayErrors     // Catch:{ all -> 0x0197 }
          if (r0 != 0) goto L_0x005f
          rx.exceptions.Exceptions.throwIfFatal(r19)     // Catch:{ all ->
      0x0197 } r22.unsubscribe()     // Catch:{ all -> 0x005b } r5 = r19
      ...
      L_0x005f:
          r2 = r19
          java.util.Queue r0 = r22.getOrCreateErrorQueue()     // Catch:{ all ->
      0x0197 } r0.offer(r2)     // Catch:{ all -> 0x0197 } L_0x0068: int r6 = r6
      + 1 int r7 = r7 + 1 long r16 = r16 - r11 r0 = r18 goto L_0x002c L_0x0071:
          if (r7 <= 0) goto L_0x007e
          if (r10 == 0) goto L_0x0078
          r16 = r8
          goto L_0x007e
      L_0x0078:
          rx.internal.operators.OperatorMerge$MergeProducer<T> r2 = r1.producer
      // Catch:{ all -> 0x0197 } long r16 = r2.produced(r7)     // Catch:{ all
      -> 0x0197 } L_0x007e: int r2 = (r16 > r14 ? 1 : (r16 == r14 ? 0 : -1)) if
      (r2 == 0) goto L_0x008c if (r0 != 0) goto L_0x0085 goto L_0x008c L_0x0085:
          r0 = r6
          r6 = r16
          goto L_0x0027
      L_0x0089:
      ...
      L_0x008c:
          ...
          java.util.Queue<java.lang.Object> r2 = r1.queue     // Catch:{ all ->
      0x0197 } rx.internal.operators.OperatorMerge$InnerSubscriber<?>[] r5 =
      r1.innerSubscribers     // Catch:{ all -> 0x0197 } int r7 = r5.length //
      Catch:{ all -> 0x0197 } if (r0 == 0) goto L_0x00b2 if (r2 == 0) goto
      L_0x009d boolean r0 = r2.isEmpty()     // Catch:{ all -> 0x0197 } if (r0
      == 0) goto L_0x00b2 L_0x009d: if (r7 != 0) goto L_0x00b2
          java.util.concurrent.ConcurrentLinkedQueue<java.lang.Throwable> r0 =
      r1.errors     // Catch:{ all -> 0x0197 } if (r0 == 0) goto L_0x00ae
      ...
      L_0x00f0:
          ...
          return
      L_0x00fb:
          rx.internal.util.RxRingBuffer r13 = r9.queue     // Catch:{ all ->
      0x0197 } if (r13 != 0) goto L_0x0100 goto L_0x0106 L_0x0100:
      ...
      rx.internal.operators.NotificationLite.getValue(r11)     // Catch:{ all ->
      0x0197 } r4.onNext(r13)     // Catch:{ all -> 0x0117 } r20 = 1 long r16 =
      r16 - r20 int r12 = r12 + 1 goto L_0x00f0 L_0x0117: r0 = move-exception r2
      = r0 rx.exceptions.Exceptions.throwIfFatal(r2)     // Catch:{ all ->
      0x005b } r4.onError(r2)     // Catch:{ all -> 0x0123 } r22.unsubscribe()
      // Catch:{ all -> 0x005b } return L_0x0123: r0 = move-exception r2 = r0
          r22.unsubscribe()     // Catch:{ all -> 0x005b }
          throw r2     // Catch:{ all -> 0x005b }
      L_0x0129:
          if (r12 <= 0) goto L_0x013d
          if (r10 != 0) goto L_0x0134
          rx.internal.operators.OperatorMerge$MergeProducer<T> r13 = r1.producer
      // Catch:{ all -> 0x0197 } long r16 = r13.produced(r12)     // Catch:{ all
      -> 0x0197 } goto L_0x0139 L_0x0134: r16 =
      9223372036854775807(0x7fffffffffffffff, double:NaN) L_0x0139: long r12 =
      (long) r12     // Catch:{ all -> 0x0197 } r9.requestMore(r12)     //
      Catch:{ all -> 0x0197 } L_0x013d: int r12 = (r16 > r14 ? 1 : (r16 == r14 ?
      0 : -1)) if (r12 == 0) goto L_0x0143 if (r11 != 0) goto L_0x00ef L_0x0143:
          boolean r11 = r9.done     // Catch:{ all -> 0x0197 }
          rx.internal.util.RxRingBuffer r13 = r9.queue     // Catch:{ all ->
      0x0197 } if (r11 == 0) goto L_0x015e if (r13 == 0) goto L_0x0151 boolean
      r11 = r13.isEmpty()     // Catch:{ all -> 0x0197 } if (r11 == 0) goto
      L_0x015e L_0x0151: r1.removeInner(r9)     // Catch:{ all -> 0x0197 }
      ...
      */
      throw new UnsupportedOperationException(
          "Method not decompiled: rx.internal.operators.OperatorMerge.MergeSubscriber.emitLoop():void");
    }
    ...
    public boolean checkTerminate() {
      ...
      ConcurrentLinkedQueue<Throwable> concurrentLinkedQueue = this.errors;
      if (this.delayErrors || concurrentLinkedQueue == null ||
  ...
  static final class InnerSubscriber<T> extends Subscriber<T> {
    ...
    public void onNext(T t) { this.parent.tryEmit(this, t); }
