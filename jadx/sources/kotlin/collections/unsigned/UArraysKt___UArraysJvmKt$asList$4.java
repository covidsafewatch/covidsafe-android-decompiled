...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m380containsxj2QHRw(((UShort) obj).m296unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m381indexOfxj2QHRw(((UShort) obj).m296unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m382lastIndexOfxj2QHRw(((UShort) obj).m296unboximpl());
        }
        return -1;
    }

    public int getSize() {
        return UShortArray.m305getSizeimpl(this.$this_asList);
    }

    public boolean isEmpty() {
        return UShortArray.m307isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public boolean m380containsxj2QHRw(short s) {
        return UShortArray.m300containsxj2QHRw(this.$this_asList, s);
    }

    public UShort get(int i) {
        return UShort.m249boximpl(UShortArray.m304getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m381indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m382lastIndexOfxj2QHRw(short s) {
