...
public final class AppBarConfigurationKt {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(Set set, DrawerLayout drawerLayout, Function0 function0, int i, Object obj) {
        ...
        Intrinsics.checkParameterIsNotNull(function0, "fallbackOnNavigateUpListener");
        AppBarConfiguration build = new AppBarConfiguration.Builder((Set<Integer>) set).setDrawerLayout(drawerLayout).setFallbackOnNavigateUpListener(new AppBarConfigurationKt$sam$i$androidx_navigation_ui_AppBarConfiguration_OnNavigateUpListener$0(function0)).build();
        Intrinsics.checkExpressionValueIsNotNull(build, "AppBarConfiguration.Buil…eUpListener)\n    .build()");
        return build;
    }
