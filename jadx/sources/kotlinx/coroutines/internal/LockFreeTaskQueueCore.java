...
public final class LockFreeTaskQueueCore<E> {
  ...
  public final int getSize() {
    long j = this._state;
    return (((int)((j & TAIL_MASK) >> 30)) - ((int)((HEAD_MASK & j) >> 0))) &
        MAX_CAPACITY_MASK;
  }
  ...
  private final LockFreeTaskQueueCore<E> allocateNextCopy(long j) {
    LockFreeTaskQueueCore<E> lockFreeTaskQueueCore =
        new LockFreeTaskQueueCore<>(this.capacity * 2, this.singleConsumer);
  ...
  public final boolean isClosed() { return (this._state & CLOSED_MASK) != 0; }

  @Metadata(
      bv = {1, 0, 3},
      d1 =
          {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"},
      d2 = {"Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Placeholder;",
            "", "index", "", "(I)V", "kotlinx-coroutines-core"},
      k = 1, mv = {1, 1, 16})
  /* compiled from: LockFreeTaskQueue.kt */
  public static final class Placeholder {
    public final int index;

    public Placeholder(int i) { this.index = i; }
  }
  ...
  @Metadata(
      ...
      d2 = {"Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Companion;",
            "",
            "()V",
            "ADD_CLOSED",
            "",
  ...
  public static final class Companion {
    ...
    public final long wo(long j, long j2) { return j & (~j2); }
    ...
    public final <T> T withState(
        long j,
        Function2<? super Integer, ? super Integer, ? extends T> function2) {
      return function2.invoke(
          Integer.valueOf((int)((LockFreeTaskQueueCore.HEAD_MASK & j) >> 0)),
          Integer.valueOf((int)((j & LockFreeTaskQueueCore.TAIL_MASK) >> 30)));
    }
  }
  ...
  static {
    ...
    _next$FU =
        AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, "_next");
  ...
  /* JADX WARNING: Removed duplicated region for block: B:19:0x006a A[LOOP:1:
B:19:0x006a->B:22:0x007c, LOOP_START, PHI: r0 PHI: (r0v14
kotlinx.coroutines.internal.LockFreeTaskQueueCore) = (r0v13
kotlinx.coroutines.internal.LockFreeTaskQueueCore), (r0v16
kotlinx.coroutines.internal.LockFreeTaskQueueCore) binds: [B:18:0x0060,
B:22:0x007c] A[DONT_GENERATE, DONT_INLINE]] */
  ...
  public final int addLast(E r13) {
    ...
    L_0x0000:
        long r2 = r12._state
        r0 = 3458764513820540928(0x3000000000000000,
    double:1.727233711018889E-77) long r0 = r0 & r2 r6 = 0 int r0 = (r0 > r6 ? 1
    : (r0 == r6 ? 0 : -1)) if (r0 == 0) goto L_0x0012
        kotlinx.coroutines.internal.LockFreeTaskQueueCore$Companion r13 =
    Companion int r13 = r13.addFailReason(r2) return r13 L_0x0012: r0 =
    1073741823(0x3fffffff, double:5.304989472E-315) long r0 = r0 & r2 r8 = 0
        long r0 = r0 >> r8
        int r0 = (int) r0
        r4 = 1152921503533105152(0xfffffffc0000000,
    double:1.2882296003504729E-231) long r4 = r4 & r2 r1 = 30 long r4 = r4 >> r1
        int r9 = (int) r4
        int r10 = r12.mask
        int r1 = r9 + 2
        r1 = r1 & r10
    ...
    L_0x004d:
        ...
        kotlinx.coroutines.internal.LockFreeTaskQueueCore$Companion r4 =
    Companion long r4 = r4.updateTail(r2, r0) r0 = r1 r1 = r12 boolean r0 =
    r0.compareAndSet(r1, r2, r4) if (r0 == 0) goto L_0x0000
        java.util.concurrent.atomic.AtomicReferenceArray r0 = r12.array
        r1 = r9 & r10
        r0.set(r1, r13)
        r0 = r12
        kotlinx.coroutines.internal.LockFreeTaskQueueCore r0 =
    (kotlinx.coroutines.internal.LockFreeTaskQueueCore) r0 L_0x006a: long r1 =
    r0._state r3 = 1152921504606846976(0x1000000000000000,
    double:1.2882297539194267E-231) long r1 = r1 & r3 int r1 = (r1 > r6 ? 1 :
    (r1 == r6 ? 0 : -1)) if (r1 != 0) goto L_0x0074 goto L_0x007f L_0x0074:
        kotlinx.coroutines.internal.LockFreeTaskQueueCore r0 = r0.next()
        kotlinx.coroutines.internal.LockFreeTaskQueueCore r0 =
    r0.fillPlaceholder(r9, r13) if (r0 == 0) goto L_0x007f goto L_0x006a
    L_0x007f:
        return r8
    */
    throw new UnsupportedOperationException(
        "Method not decompiled: kotlinx.coroutines.internal.LockFreeTaskQueueCore.addLast(java.lang.Object):int");
  }
  ...
  private final LockFreeTaskQueueCore<E> allocateOrGetNextCopy(long j) {
    while (true) {
      LockFreeTaskQueueCore<E> lockFreeTaskQueueCore =
          (LockFreeTaskQueueCore)this._next;
