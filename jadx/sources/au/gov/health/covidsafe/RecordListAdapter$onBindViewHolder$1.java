...
final class RecordListAdapter$onBindViewHolder$1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        if (tag != null) {
            this.this$0.setMode(RecordListAdapter.MODE.MODEL_P, (StreetPassRecordViewModel) tag);
            return;
        }
