...
public final class PlotActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Observable.zip(create, create2, PlotActivity$onCreate$zipResult$1.INSTANCE).observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io()).subscribe(new PlotActivity$onCreate$zipResult$2(intExtra, webView));
