...
@Metadata(
    ...
    d2 = {"Lau/gov/health/covidsafe/SplashActivity;",
...
public final class SplashActivity extends AppCompatActivity {
  ...
  public void onCreate(Bundle bundle) {
    ...
    Intrinsics.checkExpressionValueIsNotNull(
        string, "Settings.Secure.getStrin…ttings.Secure.ANDROID_ID)");
  ...
  public void onResume() {
    ...
    if (!this.updateFlag) {
      ...
      handler.postDelayed(new SplashActivity$onResume$1(this),
                          this.SPLASH_TIME);
    }
  }
  ...
  public final void goToNextScreen() {
    ...
    instance.setTimeInMillis(
        Preference.INSTANCE.getDataUploadedDateMs(context));
