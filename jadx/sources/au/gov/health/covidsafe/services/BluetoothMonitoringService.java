...
public final class BluetoothMonitoringService
    extends LifecycleService implements CoroutineScope {
  ...
  private final BluetoothStatusReceiver bluetoothStatusReceiver =
      new BluetoothStatusReceiver();
  private CommandHandler commandHandler;
  private final BluetoothMonitoringService$connection$1 connection =
      new BluetoothMonitoringService$connection$1(this);
  ...
  public static final /* synthetic */ SensorMonitoringService
  access$getMService$p(BluetoothMonitoringService bluetoothMonitoringService) {
    SensorMonitoringService sensorMonitoringService =
        bluetoothMonitoringService.mService;
  ...
  public static final /* synthetic */ StatusRecordStorage
  access$getStatusRecordStorage$p(
      BluetoothMonitoringService bluetoothMonitoringService) {
    StatusRecordStorage statusRecordStorage2 =
        bluetoothMonitoringService.statusRecordStorage;
  ...
  public static final /* synthetic */ StreetPassRecordStorage
  access$getStreetPassRecordStorage$p(
      BluetoothMonitoringService bluetoothMonitoringService) {
    StreetPassRecordStorage streetPassRecordStorage2 =
        bluetoothMonitoringService.streetPassRecordStorage;
  ...
  private final void setup() {
    ...
    if (systemService != null) {
      ...
      CentralLog.Companion.d(TAG,
                             "Creating service - BluetoothMonitoringService");
      ...
      Intrinsics.checkExpressionValueIsNotNull(applicationContext2,
                                               "this.applicationContext");
      this.streetPassRecordStorage =
          new StreetPassRecordStorage(applicationContext2);
      Context applicationContext3 = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext3,
                                               "this.applicationContext");
      this.statusRecordStorage = new StatusRecordStorage(applicationContext3);
      PrivacyCleanerReceiver.Companion companion =
          PrivacyCleanerReceiver.Companion;
      Context applicationContext4 = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext4,
                                               "this.applicationContext");
      companion.startAlarm(applicationContext4);
      setupNotifications();
      Utils utils = Utils.INSTANCE;
      Context applicationContext5 = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext5,
                                               "this.applicationContext");
    ...
    if (systemService != null) {
      ...
      if (Build.VERSION.SDK_INT >= 26) {
        NotificationChannel notificationChannel = new NotificationChannel(
            "COVIDSafe Updates", "Foreground Service", 2);
  ...
  private final boolean hasLocationPermissions() {
    ...
    return EasyPermissions.hasPermissions(
        ...
        (String[])Arrays.copyOf(requiredPermissions,
                                requiredPermissions.length));
  }

  private final boolean isBluetoothEnabled() {
    BluetoothAdapter bluetoothAdapter =
        (BluetoothAdapter)LazyKt
            .lazy(
                LazyThreadSafetyMode.NONE,
                new BluetoothMonitoringService$isBluetoothEnabled$bluetoothAdapter$2(
                    this))
            .getValue();
  ...
  public int onStartCommand(Intent intent, int i, int i2) {
    ...
    bindService(
        new Intent(getApplicationContext(), SensorMonitoringService.class),
        this.connection, 1);
    if (!hasLocationPermissions() || !isBluetoothEnabled()) {
      CentralLog.Companion companion = CentralLog.Companion;
      companion.i(TAG, "location permission: " + hasLocationPermissions() +
                           " bluetooth: " + isBluetoothEnabled());
      NotificationTemplates.Companion companion2 =
          NotificationTemplates.Companion;
      Context applicationContext = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext,
                                               "this.applicationContext");
      startForeground(771579, companion2.lackingThingsNotification(
                                  applicationContext, "COVIDSafe Updates"));
      return 1;
    } else if (intent != null) {
      runService(Command.Companion.findByValue(
          intent.getIntExtra(COMMAND_KEY, Command.INVALID.getIndex())));
      return 1;
    } else {
  ...
  public final void runService(Command command) {
    ...
    if (!hasLocationPermissions() || !isBluetoothEnabled()) {
      ...
      companion2.i(TAG, "location permission: " + hasLocationPermissions() +
                            " bluetooth: " + isBluetoothEnabled());
      NotificationTemplates.Companion companion3 =
          NotificationTemplates.Companion;
      Context applicationContext = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext,
                                               "this.applicationContext");
      startForeground(771579, companion3.lackingThingsNotification(
                                  applicationContext, "COVIDSafe Updates"));
      return;
    }
    if (command != null) {
  ...
  /* JADX WARNING: Code restructure failed: missing block: B:5:0x0040, code
     lost: if (r0.needToUpdate(r2) == false) goto L_0x0042;
   */
  /* Code decompiled incorrectly, please refer to instructions dump. */
  private final void actionStart() {
    /*
        r6 = this;
        au.gov.health.covidsafe.Preference r0 =
    au.gov.health.covidsafe.Preference.INSTANCE r1 = r6 android.content.Context
    r1 = (android.content.Context) r1 boolean r0 = r0.isOnBoarded(r1) if (r0 ==
    0) goto L_0x007a au.gov.health.covidsafe.logging.CentralLog$Companion r0 =
    au.gov.health.covidsafe.logging.CentralLog.Companion java.lang.String r2 =
    "BTMService" java.lang.String r3 = "Service Starting " r0.d(r2, r3) r0 =
    771579(0xbc5fb, float:1.081212E-39)
        au.gov.health.covidsafe.notifications.NotificationTemplates$Companion r2
    = au.gov.health.covidsafe.notifications.NotificationTemplates.Companion
        ...
        au.gov.health.covidsafe.Preference r0 =
    au.gov.health.covidsafe.Preference.INSTANCE boolean r0 = r0.isOnBoarded(r1)
        if (r0 == 0) goto L_0x0042
        au.gov.health.covidsafe.Utils r0 =
    au.gov.health.covidsafe.Utils.INSTANCE android.content.Context r2 =
    ...
    au.gov.health.covidsafe.interactor.usecase.UpdateBroadcastMessageAndPerformScanWithExponentialBackOff
        ...
        r0.<init>(r1, r2, r3)
        r1 = 0
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionStart$1
    r2 = new
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionStart$1
        r2.<init>(r6)
        kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionStart$2
    r3 =
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionStart$2.INSTANCE
    ...
    */
    throw new UnsupportedOperationException(
        "Method not decompiled: au.gov.health.covidsafe.services.BluetoothMonitoringService.actionStart():void");
  }

  /* JADX WARNING: Code restructure failed: missing block: B:3:0x0032, code
     lost: if (r0.needToUpdate(r3) == false) goto L_0x0034;
   */
  /* Code decompiled incorrectly, please refer to instructions dump. */
  private final void actionUpdateBm() {
    /*
        r5 = this;
        au.gov.health.covidsafe.Utils r0 =
    au.gov.health.covidsafe.Utils.INSTANCE android.content.Context r1 =
    r5.getApplicationContext() java.lang.String r2 = "this.applicationContext"
        kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r1, r2)
        r3 = 540000(0x83d60, double:2.667954E-318)
        r0.scheduleBMUpdateCheck(r1, r3)
        au.gov.health.covidsafe.logging.CentralLog$Companion r0 =
    au.gov.health.covidsafe.logging.CentralLog.Companion java.lang.String r1 =
    "BTMService" java.lang.String r3 = "checking need to update BM" r0.i(r1, r3)
        au.gov.health.covidsafe.Preference r0 =
    au.gov.health.covidsafe.Preference.INSTANCE r3 = r5 android.content.Context
    r3 = (android.content.Context) r3 boolean r0 = r0.isOnBoarded(r3) if (r0 ==
    0) goto L_0x0034 au.gov.health.covidsafe.Utils r0 =
    au.gov.health.covidsafe.Utils.INSTANCE android.content.Context r3 =
    ...
    au.gov.health.covidsafe.interactor.usecase.UpdateBroadcastMessageAndPerformScanWithExponentialBackOff
        ...
        r0.<init>(r1, r2, r3)
        r1 = 0
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionUpdateBm$1
    r2 =
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionUpdateBm$1.INSTANCE
        kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionUpdateBm$2
    r3 =
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionUpdateBm$2.INSTANCE
        kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3
        r0.invoke(r1, r2, r3)
        goto L_0x0065
    L_0x005e:
        au.gov.health.covidsafe.logging.CentralLog$Companion r0 =
    au.gov.health.covidsafe.logging.CentralLog.Companion java.lang.String r2 =
    "Don't need to update bm" r0.i(r1, r2) L_0x0065: return
    */
    throw new UnsupportedOperationException(
        "Method not decompiled: au.gov.health.covidsafe.services.BluetoothMonitoringService.actionUpdateBm():void");
  }
  ...
  /* JADX WARNING: Code restructure failed: missing block: B:3:0x001a, code
     lost: if (r0.needToUpdate(r2) == false) goto L_0x001c;
   */
  /* Code decompiled incorrectly, please refer to instructions dump. */
  private final void actionScan() {
    /*
        r5 = this;
        au.gov.health.covidsafe.Preference r0 =
    au.gov.health.covidsafe.Preference.INSTANCE r1 = r5 android.content.Context
    r1 = (android.content.Context) r1 boolean r0 = r0.isOnBoarded(r1) if (r0 ==
    0) goto L_0x001c au.gov.health.covidsafe.Utils r0 =
    au.gov.health.covidsafe.Utils.INSTANCE android.content.Context r2 =
    r5.getApplicationContext() java.lang.String r3 = "this.applicationContext"
        kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r2, r3)
        boolean r0 = r0.needToUpdate(r2)
    ...
    au.gov.health.covidsafe.interactor.usecase.UpdateBroadcastMessageAndPerformScanWithExponentialBackOff
        ...
        r0.<init>(r1, r2, r3)
        r1 = 0
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionScan$1
    r2 = new
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionScan$1
        r2.<init>(r5)
        kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2
        au.gov.health.covidsafe.services.BluetoothMonitoringService$actionScan$2
    r3 =
    au.gov.health.covidsafe.services.BluetoothMonitoringService$actionScan$2.INSTANCE
        kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3
        r0.invoke(r1, r2, r3)
        goto L_0x0054
    L_0x0049:
    ...
    */
    throw new UnsupportedOperationException(
        "Method not decompiled: au.gov.health.covidsafe.services.BluetoothMonitoringService.actionScan():void");
  }
  ...
  private final void actionAdvertise() {
    ...
    if (isBluetoothEnabled()) {
      ...
      CentralLog.Companion.w(TAG,
                             "Unable to start advertising, bluetooth is off");
    }
    CommandHandler commandHandler2 = this.commandHandler;
    if (commandHandler2 == null) {
      Intrinsics.throwUninitializedPropertyAccessException("commandHandler");
  ...
  private final void setupScanCycles() { actionScan(); }

  private final void setupAdvertisingCycles() { actionAdvertise(); }
  ...
  private final void performHealthCheck() {
    ...
    if (!hasLocationPermissions() || !isBluetoothEnabled()) {
      ...
      NotificationTemplates.Companion companion =
          NotificationTemplates.Companion;
      Context applicationContext = getApplicationContext();
      Intrinsics.checkExpressionValueIsNotNull(applicationContext,
                                               "this.applicationContext");
      startForeground(771579, companion.lackingThingsNotification(
                                  applicationContext, "COVIDSafe Updates"));
      return;
    }
    NotificationTemplates.Companion companion2 =
    ...
    Intrinsics.checkExpressionValueIsNotNull(applicationContext2,
                                             "this.applicationContext");
    startForeground(771579, companion2.getRunningNotification(
                                applicationContext2, "COVIDSafe Updates"));
    setupService();
    CommandHandler commandHandler2 = this.commandHandler;
    if (commandHandler2 == null) {
      Intrinsics.throwUninitializedPropertyAccessException("commandHandler");
    ...
    BLEAdvertiser bLEAdvertiser = this.advertiser;
    boolean z = false;
    sb.append(bLEAdvertiser != null ? bLEAdvertiser.getShouldBeAdvertising()
                                    : false);
  ...
  public void onDestroy() {
    super.onDestroy();
    CentralLog.Companion.i(
        TAG, "BluetoothMonitoringService destroyed - tearing down");
    teardown();
    unregisterReceivers();
    ...
    Job.DefaultImpls.cancel$default(this.job, (CancellationException)null, 1,
                                    (Object)null);
    if (this.mBound) {
  ...
  private final void registerReceivers() {
    IntentFilter intentFilter =
        new IntentFilter(GATTKt.ACTION_RECEIVED_STREETPASS);
    LocalBroadcastManager localBroadcastManager2 = this.localBroadcastManager;
    if (localBroadcastManager2 == null) {
      Intrinsics.throwUninitializedPropertyAccessException(
          "localBroadcastManager");
    }
    localBroadcastManager2.registerReceiver(this.streetPassReceiver,
                                            intentFilter);
    IntentFilter intentFilter2 =
        new IntentFilter(GATTKt.ACTION_RECEIVED_STATUS);
  ...
  @Metadata(
      ...
      d2 =
          {"Lau/gov/health/covidsafe/services/BluetoothMonitoringService$BluetoothStatusReceiver;",
           ...
           "onReceive", "", "context", "Landroid/content/Context;", "intent",
    ...
    public void onReceive(Context context, Intent intent) {
      if (intent != null &&
          Intrinsics.areEqual(
              ...
              (Object) "android.bluetooth.adapter.action.STATE_CHANGED")) {
        switch (
            intent.getIntExtra("android.bluetooth.adapter.extra.STATE", -1)) {
        case 10:
          CentralLog.Companion.d(BluetoothMonitoringService.TAG,
        ...
        case 12:
          ...
          Context applicationContext =
              BluetoothMonitoringService.this.getApplicationContext();
          Intrinsics.checkExpressionValueIsNotNull(
              applicationContext,
        ...
        case 13:
          ...
          Intrinsics.checkExpressionValueIsNotNull(
              applicationContext2,
              "this@BluetoothMonitoringService.applicationContext");
          BluetoothMonitoringService.this.startForeground(
              771579, companion.lackingThingsNotification(applicationContext2,
                                                          "COVIDSafe Updates"));
  ...
  @Metadata(
      ...
      d2 =
          {"Lau/gov/health/covidsafe/services/BluetoothMonitoringService$StreetPassReceiver;",
           "Landroid/content/BroadcastReceiver;",
           "(Lau/gov/health/covidsafe/services/BluetoothMonitoringService;)V",
           "TAG", "", "onReceive", "", "context", "Landroid/content/Context;",
           "intent", "Landroid/content/Intent;", "app_release"},
      k = 1, mv = {1, 1, 16})
  /* compiled from: BluetoothMonitoringService.kt */
  public final class StreetPassReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (Intrinsics.areEqual((Object)GATTKt.ACTION_RECEIVED_STREETPASS,
                              (Object)intent.getAction())) {
        Parcelable parcelableExtra =
            intent2.getParcelableExtra(GATTKt.STREET_PASS);
        Intrinsics.checkExpressionValueIsNotNull(
            parcelableExtra, "intent.getParcelableExtra(STREET_PASS)");
          ...
          if (BluetoothMonitoringService.this.mBound) {
            float proximity =
                BluetoothMonitoringService
                    .access$getMService$p(BluetoothMonitoringService.this)
                    .getProximity();
            float light =
                BluetoothMonitoringService
                    .access$getMService$p(BluetoothMonitoringService.this)
            ...
            companion2.d(
                str2,
                "Sensor values just before saving StreetPassRecord: proximity=" +
                    proximity + " light=" + light);
          }
          Job unused = BuildersKt__Builders_commonKt.launch$default(
              BluetoothMonitoringService.this, (CoroutineContext)null,
              (CoroutineStart)null,
              new BluetoothMonitoringService$StreetPassReceiver$onReceive$1(
                  this,
                  new StreetPassRecord(
                      connectionRecord.getVersion(), connectionRecord.getMsg(),
                      connectionRecord.getOrg(),
                      connectionRecord.getPeripheral().getModelP(),
                      connectionRecord.getCentral().getModelC(),
                      connectionRecord.getRssi(),
                      connectionRecord.getTxPower()),
                  (Continuation)null),
              3, (Object)null);
        }
      }
  ...
  public final class StatusReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (Intrinsics.areEqual((Object)GATTKt.ACTION_RECEIVED_STATUS,
                              (Object)intent.getAction())) {
        Parcelable parcelableExtra = intent.getParcelableExtra(GATTKt.STATUS);
        Intrinsics.checkExpressionValueIsNotNull(
            parcelableExtra, "intent.getParcelableExtra(STATUS)");
        ...
        if (status.getMsg().length() > 0) {
          Job unused = BuildersKt__Builders_commonKt.launch$default(
              BluetoothMonitoringService.this, (CoroutineContext)null,
              (CoroutineStart)null,
              new BluetoothMonitoringService$StatusReceiver$onReceive$1(
                  this, new StatusRecord(status.getMsg()), (Continuation)null),
              3, (Object)null);
        }
      }
    }
  ...
  public enum Command {
    ...
    public final String getString() { return this.string; }

    static {
      int i;
      Companion = new Companion((DefaultConstructorMarker)null);
      Command[] values = values();
      Map<Integer, Command> linkedHashMap = new LinkedHashMap<>(
          RangesKt.coerceAtLeast(MapsKt.mapCapacity(values.length), 16));
  ...
  @Metadata(
      ...
      d2 =
          {"Lau/gov/health/covidsafe/services/BluetoothMonitoringService$Companion;",
           ...
           "CHANNEL_SERVICE",
           "COMMAND_KEY",
           "DAILY_UPLOAD_NOTIFICATION_CODE",
           "",
           "NOTIFICATION_ID",
           "PENDING_ACTIVITY",
