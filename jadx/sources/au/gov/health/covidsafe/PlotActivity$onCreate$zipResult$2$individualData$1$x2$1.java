...
final class PlotActivity$onCreate$zipResult$2$individualData$1$x2$1 extends Lambda implements Function1<StreetPassRecord, String> {
    final /* synthetic */ PlotActivity$onCreate$zipResult$2$individualData$1 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PlotActivity$onCreate$zipResult$2$individualData$1$x2$1(PlotActivity$onCreate$zipResult$2$individualData$1 plotActivity$onCreate$zipResult$2$individualData$1) {
        super(1);
