...
@Metadata(
    ...
    d1 =
        {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u00002\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\b¨\u0006\t"},
    d2 = {"Lau/gov/health/covidsafe/ui/home/view/ExternalLinkCard;",
          "Landroidx/constraintlayout/widget/ConstraintLayout;", "context",
...
public final class ExternalLinkCard extends ConstraintLayout {
   ...
   * semantics) */
  public /* synthetic */ ExternalLinkCard(
  ...
  public ExternalLinkCard(Context context, AttributeSet attributeSet, int i) {
    ...
    LayoutInflater.from(context).inflate(R.layout.view_card_external_link_card,
                                         this, true);
    TypedArray obtainStyledAttributes = context.obtainStyledAttributes(
        attributeSet, R.styleable.ExternalLinkCard);
    Intrinsics.checkExpressionValueIsNotNull(
        obtainStyledAttributes,
        "context.obtainStyledAttr…yleable.ExternalLinkCard)");
    ...
    ((ImageView)_$_findCachedViewById(R.id.external_link_round_image))
    ...
    TextView textView =
        (TextView)_$_findCachedViewById(R.id.external_link_headline);
    Intrinsics.checkExpressionValueIsNotNull(textView,
                                             "external_link_headline");
    textView.setText(string);
    TextView textView2 =
        (TextView)_$_findCachedViewById(R.id.external_link_content);
