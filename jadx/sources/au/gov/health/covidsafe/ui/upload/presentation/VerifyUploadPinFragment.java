...
public final class VerifyUploadPinFragment extends PagerChildFragment {
  ...
  @Metadata(
      ...
      d2 =
          {"Lau/gov/health/covidsafe/ui/upload/presentation/VerifyUploadPinFragment$OnUploadErrorInterface;",
           "", "onNegativeClicked", "", "onPositiveClicked", "app_release"},
      k = 1, mv = {1, 1, 16})
  /* compiled from: VerifyUploadPinFragment.kt */
  ...
  public static final /* synthetic */ VerifyUploadPinPresenter
  access$getPresenter$p(VerifyUploadPinFragment verifyUploadPinFragment) {
    VerifyUploadPinPresenter verifyUploadPinPresenter =
        verifyUploadPinFragment.presenter;
  ...
  public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup,
    ...
    return layoutInflater.inflate(R.layout.fragment_verify_upload_pin,
                                  viewGroup, false);
  }
  ...
  public void onResume() {
    ...
    ((PinInputView)_$_findCachedViewById(R.id.pin))
        .setOnPinChanged(new VerifyUploadPinFragment$onResume$1(this));
  }
  ...
  public UploadButtonLayout.ContinueLayout getUploadButtonLayout() {
    return new UploadButtonLayout.ContinueLayout(
        R.string.action_verify_upload_pin,
        new VerifyUploadPinFragment$getUploadButtonLayout$1(this));
  }
  ...
  public final void showGenericError() {
    ...
    if (activity != null) {
      ...
      Dialog uploadingErrorDialog = new UploadingErrorDialog(
          activity,
          new VerifyUploadPinFragment$showGenericError$$inlined$let$lambda$1(
              this));
  ...
  public final void navigateToRegister() {
    BaseFragment.navigateTo$default(
        this,
        VerifyUploadPinFragmentDirections.Companion
            .actionVerifyUploadPinFragmentToEnterNumberFragment()
            .getActionId(),
        BundleKt.bundleOf(TuplesKt.to(
            "destination_id",
            Integer.valueOf(
                R.id.action_enterPinFragment_to_uploadStepFourFragment))),
        (Navigator.Extras)null, 4, (Object)null);
  }

  public final void navigateToNextPage() {
    BaseFragment.navigateTo$default(
        this, R.id.action_verifyUploadPinFragment_to_uploadFinishedFragment,
