...
@Metadata(
    ...
    d2 =
        {"Lau/gov/health/covidsafe/ui/upload/presentation/VerifyUploadPinPresenter;",
         "Landroidx/lifecycle/LifecycleObserver;", "fragment",
         ...
         "uploadData",
         "Lau/gov/health/covidsafe/interactor/usecase/UploadData;", "onCreate",
         "", "otp", "uploadData$app_release", "app_release"},
    k = 1, mv = {1, 1, 16})
...
public final class VerifyUploadPinPresenter implements LifecycleObserver {
  ...
  public VerifyUploadPinPresenter(
  ...
  access$getRecordStorage$p(VerifyUploadPinPresenter verifyUploadPinPresenter) {
    StreetPassRecordStorage streetPassRecordStorage =
        verifyUploadPinPresenter.recordStorage;
  ...
  private final void onCreate() {
    ...
    this.uploadData =
        new UploadData(awsClient2, okHttpClient, context, lifecycle);
  }
  ...
  public final void uploadData$app_release(String str) {
    ...
    if (activity == null || NetworkExtensionsKt.isInternetAvailable(activity)) {
      ...
      uploadData2.invoke(str, new VerifyUploadPinPresenter$uploadData$1(this),
                         new VerifyUploadPinPresenter$uploadData$2(this));
      return;
    }
