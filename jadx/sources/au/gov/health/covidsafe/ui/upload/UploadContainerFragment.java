...
@Metadata(
    ...
    d2 = {"Lau/gov/health/covidsafe/ui/upload/UploadContainerFragment;",
...
public final class UploadContainerFragment
    extends Fragment implements PagerContainer {
  ...
  public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup,
    ...
    return layoutInflater.inflate(R.layout.fragment_upload_master, viewGroup,
                                  false);
  }
  ...
  public void onResume() {
    ...
    ((Toolbar)_$_findCachedViewById(R.id.toolbar))
        .setNavigationOnClickListener(
            new UploadContainerFragment$onResume$1(this));
  }
  ...
  public void updateProgressBar(Integer num) {
    if (num == null) {
      SegmentedProgressBar segmentedProgressBar =
          (SegmentedProgressBar)_$_findCachedViewById(R.id.upload_progress);
      Intrinsics.checkExpressionValueIsNotNull(segmentedProgressBar,
                                               "upload_progress");
    ...
    SegmentedProgressBar segmentedProgressBar2 =
        (SegmentedProgressBar)_$_findCachedViewById(R.id.upload_progress);
    Intrinsics.checkExpressionValueIsNotNull(segmentedProgressBar2,
                                             "upload_progress");
  ...
  public void setNavigationIcon(Integer num) {
    ...
    if (activity != null) {
      ...
      toolbar2.setNavigationIcon(
          ContextCompat.getDrawable(activity, num.intValue()));
    }
  }

  public void refreshButton(UploadButtonLayout uploadButtonLayout) {
    Intrinsics.checkParameterIsNotNull(uploadButtonLayout,
                                       "uploadButtonLayout");
    if (uploadButtonLayout instanceof UploadButtonLayout.ContinueLayout) {
      ((Button)_$_findCachedViewById(R.id.upload_continue))
          .setOnClickListener(
              new UploadContainerFragment$refreshButton$1(uploadButtonLayout));
      ((Button)_$_findCachedViewById(R.id.upload_continue))
          .setText(((UploadButtonLayout.ContinueLayout)uploadButtonLayout)
                       .getButtonText());
      ...
      ((Button)_$_findCachedViewById(R.id.upload_answerNo))
          .setOnClickListener((View.OnClickListener)null);
      ((Button)_$_findCachedViewById(R.id.upload_answerYes))
          .setOnClickListener((View.OnClickListener)null);
    ...
    } else if (uploadButtonLayout instanceof
               UploadButtonLayout.QuestionLayout) {
      ((Button)_$_findCachedViewById(R.id.upload_continue))
          .setOnClickListener((View.OnClickListener)null);
      ...
      ((Button)_$_findCachedViewById(R.id.upload_answerNo))
          .setOnClickListener(
              new UploadContainerFragment$refreshButton$2(uploadButtonLayout));
      ((Button)_$_findCachedViewById(R.id.upload_answerYes))
          .setOnClickListener(
              new UploadContainerFragment$refreshButton$3(uploadButtonLayout));
  ...
  public void showLoading() {
    ...
    DrawableButtonExtensionsKt.showProgress(
        (TextView)button, (Function1<? super ProgressParams, Unit>)
                              UploadContainerFragment$showLoading$1.INSTANCE);
  }
  ...
  public void hideLoading(Integer num) {
    if (num == null) {
      Button button = (Button)_$_findCachedViewById(R.id.upload_continue);
      Intrinsics.checkExpressionValueIsNotNull(button, "upload_continue");
      DrawableButtonExtensionsKt.hideProgress$default(button, (String)null, 1,
                                                      (Object)null);
      return;
    }
