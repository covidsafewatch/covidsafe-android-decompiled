...
public final class HowItWorksFragment extends PagerChildFragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(textView, "view.how_it_works_content");
        textView.setMovementMethod(LinkMovementMethod.getInstance());
    }

    public UploadButtonLayout.ContinueLayout getUploadButtonLayout() {
        return new UploadButtonLayout.ContinueLayout(R.string.how_it_works_button, new HowItWorksFragment$getUploadButtonLayout$1(this));
    }
