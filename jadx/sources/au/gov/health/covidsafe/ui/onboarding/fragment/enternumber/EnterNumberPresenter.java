...
@Metadata(
    ...
    d2 =
        {"Lau/gov/health/covidsafe/ui/onboarding/fragment/enternumber/EnterNumberPresenter;",
         "Landroidx/lifecycle/LifecycleObserver;", "enterNumberFragment",
         ...
         "TAG", "", "getOnboardingOtp",
         "Lau/gov/health/covidsafe/interactor/usecase/GetOnboardingOtp;",
         "phoneNumber", "makeOTPCall", "", "onCreate", "requestOTP",
         "requestOTP$app_release", "validateAuNumber", "",
         "validateAuNumber$app_release", "app_release"},
    k = 1, mv = {1, 1, 16})
...
public final class EnterNumberPresenter implements LifecycleObserver {
  ...
  public EnterNumberPresenter(EnterNumberFragment enterNumberFragment2) {
    Intrinsics.checkParameterIsNotNull(enterNumberFragment2,
                                       "enterNumberFragment");
  ...
  public final void requestOTP$app_release(String str) {
    ...
    if (activity != null &&
        !NetworkExtensionsKt.isInternetAvailable(activity)) {
      ...
      if (StringsKt.startsWith$default(str, "0", false, 2, (Object)null)) {
        str = StringsKt.takeLast(
            str, TracerApp.Companion.getAppContext().getResources().getInteger(
                     R.integer.australian_phone_number_length));
      }
      Preference.INSTANCE.putPhoneNumber(
          TracerApp.Companion.getAppContext(),
          this.enterNumberFragment.getResources().getString(
              R.string.enter_number_prefix) +
              str);
  ...
  private final void makeOTPCall(String str) {
    if (this.enterNumberFragment.getActivity() != null) {
      ...
      String deviceID = Preference.INSTANCE.getDeviceID(
          this.enterNumberFragment.requireContext());
      Preference preference = Preference.INSTANCE;
      Context requireContext = this.enterNumberFragment.requireContext();
      Intrinsics.checkExpressionValueIsNotNull(
          requireContext, "enterNumberFragment.requireContext()");
      ...
      Intrinsics.checkExpressionValueIsNotNull(
          requireContext2, "enterNumberFragment.requireContext()");
      ...
      Intrinsics.checkExpressionValueIsNotNull(
          requireContext3, "enterNumberFragment.requireContext()");
      getOnboardingOtp2.invoke(
          new GetOtpParams(str, deviceID, postCode, age,
                           preference3.getName(requireContext3)),
          new EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$1(this, str),
          new EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$2(this,
                                                                     str));
    }
  }

  public final boolean validateAuNumber$app_release(String str) {
    int integer = this.enterNumberFragment.getResources().getInteger(
        R.integer.australian_phone_number_length);
    if (str != null &&
        StringsKt.startsWith$default(str, "0", false, 2, (Object)null)) {
      integer++;
    }
