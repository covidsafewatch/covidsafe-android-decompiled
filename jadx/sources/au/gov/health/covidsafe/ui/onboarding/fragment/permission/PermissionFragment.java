...
@Metadata(
    ...
    d2 =
        {"Lau/gov/health/covidsafe/ui/onboarding/fragment/permission/PermissionFragment;",
         ...
         "hasAllPermissionsAndBluetoothOn",
...
public final class PermissionFragment
    extends PagerChildFragment implements EasyPermissions.PermissionCallbacks {
  ...
  @Metadata(
      ...
      d2 =
          {"Lau/gov/health/covidsafe/ui/onboarding/fragment/permission/PermissionFragment$Companion;",
           "", "()V", "requiredPermissions", "", "", "getRequiredPermissions",
           "()[Ljava/lang/String;", "[Ljava/lang/String;", "app_release"},
      k = 1, mv = {1, 1, 16})
  /* compiled from: PermissionFragment.kt */
  ...
  public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup,
    ...
    return layoutInflater.inflate(R.layout.fragment_permission, viewGroup,
                                  false);
  }
  ...
  public void onActivityResult(int i, int i2, Intent intent) {
    if (i == 123) {
      if (i2 == 0) {
        PermissionExtensionsKt.excludeFromBatteryOptimization(
            this, new PermissionFragment$onActivityResult$1(this));
      } else {
        PermissionExtensionsKt.requestAllPermissions(
            this, new PermissionFragment$onActivityResult$2(this));
      }
    } else if (i == 789) {
      new Handler().postDelayed(new PermissionFragment$onActivityResult$3(this),
                                1000);
    } else {
  ...
  public final void navigateToNextPage() {
    ...
    if (hasAllPermissionsAndBluetoothOn()) {
      BaseFragment.navigateTo$default(
          this, R.id.action_permissionFragment_to_permissionSuccessFragment,
  ...
  private final boolean hasAllPermissionsAndBluetoothOn() {
    ...
    if (Intrinsics.areEqual(
            (Object)PermissionExtensionsKt.isBlueToothEnabled(this),
            (Object) true)) {
      ...
      if (z) {
        PowerManager powerManager =
            (PowerManager)ContextCompat.getSystemService(appContext,
                                                         PowerManager.class);
  ...
  public void onPermissionsDenied(int i, List<String> list) {
    ...
    if (i == 345) {
      PermissionExtensionsKt.excludeFromBatteryOptimization(
          this, new PermissionFragment$onPermissionsDenied$1(this));
    } else {
      PermissionExtensionsKt.requestAllPermissions(
          this, new PermissionFragment$onPermissionsDenied$2(this));
    }
  }
  ...
  public void onPermissionsGranted(int i, List<String> list) {
    Intrinsics.checkParameterIsNotNull(list, "perms");
    PermissionExtensionsKt.requestAllPermissions(
        this, new PermissionFragment$onPermissionsGranted$1(this));
  }
  ...
  public UploadButtonLayout.ContinueLayout getUploadButtonLayout() {
    return new UploadButtonLayout.ContinueLayout(
        ...
        new PermissionFragment$getUploadButtonLayout$1(this));
  }
