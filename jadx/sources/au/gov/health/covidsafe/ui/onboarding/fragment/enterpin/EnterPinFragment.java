...
@Metadata(
    ...
    d2 =
        {"Lau/gov/health/covidsafe/ui/onboarding/fragment/enterpin/EnterPinFragment;",
         ...
         "view",
         "resetTimer",
         "showCheckInternetError",
         "showErrorOtpMustBeSixDigits",
         "showGenericError",
         "showInvalidOtp",
         "startTimer",
         "updateButtonState",
...
public final class EnterPinFragment extends PagerChildFragment {
  ...
  public static final /* synthetic */ EnterPinPresenter
  access$getPresenter$p(EnterPinFragment enterPinFragment) {
  ...
  @Metadata(
      ...
      d1 =
          {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\t"},
      d2 =
          {"Lau/gov/health/covidsafe/ui/onboarding/fragment/enterpin/EnterPinFragment$Companion;",
           "", "()V", "ENTER_PIN_CHALLENGE_NAME", "",
           "ENTER_PIN_DESTINATION_ID", "ENTER_PIN_PHONE_NUMBER",
           "ENTER_PIN_PROGRESS", "ENTER_PIN_SESSION", "app_release"},
      k = 1, mv = {1, 1, 16})
  /* compiled from: EnterPinFragment.kt */
  ...
  public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup,
    ...
    return layoutInflater.inflate(R.layout.fragment_enter_pin, viewGroup,
                                  false);
  }
  ...
  public void onViewCreated(View view, Bundle bundle) {
    ...
    if (arguments != null) {
      ...
      setStepProgress(arguments.containsKey("progress")
                          ? Integer.valueOf(arguments.getInt("progress"))
                          : null);
      TextView textView =
          (TextView)_$_findCachedViewById(R.id.enter_pin_headline);
      Intrinsics.checkExpressionValueIsNotNull(textView, "enter_pin_headline");
      textView.setText(getResources().getString(
          R.string.enter_pin_headline,
          new Object[] {getResources().getString(R.string.enter_number_prefix),
                        string3}));
      this.presenter = new EnterPinPresenter(this, string, string2, string3);
    }
    TextView textView2 =
        (TextView)_$_findCachedViewById(R.id.enter_pin_wrong_number);
    Intrinsics.checkExpressionValueIsNotNull(textView2,
                                             "enter_pin_wrong_number");
    ViewExtensionsKt.toHyperlink$default(
        textView2, (String)null, new EnterPinFragment$onViewCreated$2(this), 1,
        (Object)null);
    TextView textView3 =
        (TextView)_$_findCachedViewById(R.id.enter_pin_resend_pin);
    Intrinsics.checkExpressionValueIsNotNull(textView3, "enter_pin_resend_pin");
    ViewExtensionsKt.toHyperlink$default(
        textView3, (String)null, new EnterPinFragment$onViewCreated$3(this), 1,
        (Object)null);
  ...
  public void onResume() {
    super.onResume();
    updateButtonState();
    ((PinInputView)_$_findCachedViewById(R.id.pin))
        .setOnPinChanged(new EnterPinFragment$onResume$1(this));
  }

  public void onPause() {
    super.onPause();
    ((PinInputView)_$_findCachedViewById(R.id.pin))
        .setOnPinChanged((Function0<Unit>)null);
  }

  private final void startTimer() {
    CountDownTimer enterPinFragment$startTimer$1 =
        new EnterPinFragment$startTimer$1(
            this, ((long)1000) * this.COUNTDOWN_DURATION, 1000);
    ...
    if (activity != null) {
      ((TextView)_$_findCachedViewById(R.id.enter_pin_resend_pin))
          .setLinkTextColor(
              ContextCompat.getColor(activity, R.color.hyperlink_disabled));
    }
  }
  ...
  public final void hideKeyboard() {
    ...
    FragmentActivity activity = getActivity();
    if (activity != null &&
        (currentFocus = activity.getCurrentFocus()) != null) {
  ...
  public final void showInvalidOtp() {
    AppCompatTextView appCompatTextView =
        (AppCompatTextView)_$_findCachedViewById(R.id.enter_pin_error_label);
    Intrinsics.checkExpressionValueIsNotNull(appCompatTextView,
                                             "enter_pin_error_label");
  ...
  public final void showGenericError() {
    ...
    this.alertDialog =
        new AlertDialog.Builder(getActivity())
            ...
            .setIcon(17301543)
            .setPositiveButton(17039379, (DialogInterface.OnClickListener)null)
            .show();
  }
  ...
  public final void validateOtp() {
    ...
    View requireView = requireView();
    Intrinsics.checkExpressionValueIsNotNull(requireView, "requireView()");
    enterPinPresenter.validateOTP$app_release(
        ((PinInputView)requireView.findViewById(R.id.pin)).getValue());
  }
  ...
  public UploadButtonLayout.ContinueLayout getUploadButtonLayout() {
    return new UploadButtonLayout.ContinueLayout(
        R.string.enter_pin_button,
        new EnterPinFragment$getUploadButtonLayout$1(this));
  }
