...
final class PersonalDetailsFragment$showAgePicker$1$2 implements NumberPicker.OnValueChangeListener {
    final /* synthetic */ Ref.IntRef $selected;

    PersonalDetailsFragment$showAgePicker$1$2(Ref.IntRef intRef) {
