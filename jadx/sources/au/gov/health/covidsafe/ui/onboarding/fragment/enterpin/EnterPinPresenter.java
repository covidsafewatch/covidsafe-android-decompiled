...
public final class EnterPinPresenter implements LifecycleObserver {
  ...
  public EnterPinPresenter(EnterPinFragment enterPinFragment2, String str,
  ...
  public final void resendCode$app_release() {
    ...
    if (activity != null) {
      ...
      if (!NetworkExtensionsKt.isInternetAvailable(activity)) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(
            requireContext2, "enterPinFragment.requireContext()");
        ...
        Intrinsics.checkExpressionValueIsNotNull(
            requireContext3, "enterPinFragment.requireContext()");
        getOnboardingOtp.invoke(
            new GetOtpParams(str, deviceID, postCode, age,
                             preference3.getName(requireContext3)),
            new EnterPinPresenter$resendCode$$inlined$let$lambda$1(this),
            new EnterPinPresenter$resendCode$$inlined$let$lambda$2(this));
      }
    }
  }
  ...
  public final void validateOTP$app_release(String str) {
    ...
    if (activity == null || NetworkExtensionsKt.isInternetAvailable(activity)) {
      ...
      this.awsClient
          .respondToAuthChallenge(new AuthChallengeRequest(this.session, str))
          .enqueue(new EnterPinPresenter$validateOTP$1(this));
      return;
    }
    this.enterPinFragment.showCheckInternetError();
  }
