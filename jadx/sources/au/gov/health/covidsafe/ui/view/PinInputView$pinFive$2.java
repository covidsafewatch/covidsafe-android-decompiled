...
final class PinInputView$pinFive$2 extends Lambda implements Function0<TextInputEditText> {
    final /* synthetic */ PinInputView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PinInputView$pinFive$2(PinInputView pinInputView) {
        super(0);
        this.this$0 = pinInputView;
    }

    public final TextInputEditText invoke() {
        return (TextInputEditText) this.this$0._$_findCachedViewById(R.id.pin_5);
    }
}
