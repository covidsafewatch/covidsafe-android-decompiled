...
@Metadata(
    ...
    d2 =
        {"Lau/gov/health/covidsafe/ui/view/UploadingErrorDialog;",
         ...
         "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;",
         "app_release"},
    k = 1, mv = {1, 1, 16})
...
public final class UploadingErrorDialog extends Dialog {
   ...
   * semantics) */
  public UploadingErrorDialog(
      Context context,
      VerifyUploadPinFragment.OnUploadErrorInterface onUploadErrorInterface) {
    super(context);
  ...
  public void onCreate(Bundle bundle) {
    ...
    ((Button)findViewById(R.id.dialog_error_positive))
        .setOnClickListener(new UploadingErrorDialog$onCreate$1(this));
    ((Button)findViewById(R.id.dialog_error_negative))
        .setOnClickListener(new UploadingErrorDialog$onCreate$2(this));
  }
}
