...
public final class StreetPassRecord {
    ...
    public String toString() {
        return "StreetPassRecord(v=" + this.v + ", msg='" + this.msg + "', org='" + this.f8org + "', modelP='" + this.modelP + "', modelC='" + this.modelC + "', rssi=" + this.rssi + ", txPower=" + this.txPower + ", id=" + this.id + ", timestamp=" + this.timestamp + ')';
    }
}
