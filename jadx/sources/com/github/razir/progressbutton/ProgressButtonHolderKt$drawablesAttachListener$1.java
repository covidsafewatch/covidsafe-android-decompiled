...
public final class ProgressButtonHolderKt$drawablesAttachListener$1 implements View.OnAttachStateChangeListener {
    ...
    public void onViewDetachedFromWindow(View view) {
        ...
        } else if (activeViews.containsKey(view) && (drawableViewData = (DrawableViewData) ProgressButtonHolderKt.getActiveViews().get(view)) != null && (drawable = drawableViewData.getDrawable()) != null && (drawable instanceof Animatable)) {
