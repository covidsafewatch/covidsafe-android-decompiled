...
public final class ButtonTextAnimatorExtensionsKt {
    ...
    public static final void animateTextChange(TextView textView, SpannableString spannableString) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(textView, "textColor", new int[]{ColorUtils.setAlphaComponent(animateTextColor, 0), animateTextColor});
        ofInt.setDuration(textChangeAnimatorParams2.getFadeInMills());
        ofInt.setEvaluator(new ArgbEvaluator());
        ofInt.addListener(new ButtonTextAnimatorExtensionsKt$animateTextChange$$inlined$apply$lambda$1(textView, textChangeAnimatorParams2));
        ofInt.start();
        ObjectAnimator ofInt2 = ObjectAnimator.ofInt(textView, "textColor", new int[]{animateTextColor, ColorUtils.setAlphaComponent(animateTextColor, 0)});
        ofInt2.setDuration(textChangeAnimatorParams2.getFadeOutMills());
        ofInt2.setEvaluator(new ArgbEvaluator());
        ofInt2.addListener(new ButtonTextAnimatorExtensionsKt$animateTextChange$$inlined$apply$lambda$2(textView, textChangeAnimatorParams2, spannableString, ofInt));
        ofInt2.start();
    }
    ...
    public static final void addAnimator(TextView textView, Animator animator) {
        if (ProgressButtonHolderKt.getActiveAnimations().containsKey(textView)) {
            List list = ProgressButtonHolderKt.getActiveAnimations().get(textView);
            if (list != null) {
                list.add(animator);
                return;
            }
    ...
    public static final void cancelAnimations(TextView textView) {
        ...
        if (ProgressButtonHolderKt.getActiveAnimations().containsKey(textView)) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(list, "activeAnimations[this]!!");
            for (Animator cancel : new ArrayList(list)) {
                cancel.cancel();
            }
            ProgressButtonHolderKt.getActiveAnimations().remove(textView);
        }
