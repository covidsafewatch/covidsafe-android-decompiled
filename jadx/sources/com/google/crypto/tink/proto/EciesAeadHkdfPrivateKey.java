...
public final class EciesAeadHkdfPrivateKey extends GeneratedMessageLite<EciesAeadHkdfPrivateKey, Builder> implements EciesAeadHkdfPrivateKeyOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setPublicKey(EciesAeadHkdfPublicKey.Builder builder) {
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                EciesAeadHkdfPublicKey.Builder builder = this.publicKey_ != null ? (EciesAeadHkdfPublicKey.Builder) this.publicKey_.toBuilder() : null;
