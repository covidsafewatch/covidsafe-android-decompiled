...
public final class SendFeedbackCommand extends AbstractCommand<Result> {
    ...
    public SendFeedbackCommand(Map<String, String> map, CreateIssueRequest.Builder builder, FeedbackDataProvider feedbackDataProvider2, JmcRestClient jmcRestClient, Receiver<Result> receiver, UiNotifier uiNotifier) {
    ...
    public void run() {
        ...
        if (feedbackDataProvider2 != null) {
            ...
            if (customFieldsData != null) {
                arrayList.add(MultipartBody.Part.createFormData("customfields", "customfields.json", RequestBody.create(MediaType.parse("application/json"), new Gson().toJson((Object) customFieldsData))));
            }
        }
        ...
        try {
            ...
            if (execute.isSuccessful()) {
                ...
                if (body == null) {
                    ...
                    Log.d(LOG_TAG, String.format("New Issue Created %s", new Object[]{body.getKey()}));
