...
public final class FastServiceLoader {
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        try {
            ...
            Object obj2 = null;
            try {
                obj = (MainDispatcherFactory) cls.cast(Class.forName("kotlinx.coroutines.android.AndroidDispatcherFactory", true, cls.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            ...
            try {
                obj2 = (MainDispatcherFactory) cls.cast(Class.forName("kotlinx.coroutines.test.internal.TestMainDispatcherFactory", true, cls.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            ...
            list = load(cls, cls.getClassLoader());
        }
        return list;
    }
    ...
    public final <S> List<S> loadProviders$kotlinx_coroutines_core(Class<S> cls, ClassLoader classLoader) {
        ...
        for (URL parse : iterable) {
            CollectionsKt.addAll(arrayList, (Iterable<? extends T>) INSTANCE.parse(parse));
        }
