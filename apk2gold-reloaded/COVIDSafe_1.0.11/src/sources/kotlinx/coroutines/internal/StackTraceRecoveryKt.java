...
public final class StackTraceRecoveryKt {
    ...
    public static final <E extends Throwable> E recoverFromStackFrame(E e, CoroutineStackFrame coroutineStackFrame) {
        ...
        if (tryCopyException != null) {
            if (!Intrinsics.areEqual((Object) tryCopyException.getMessage(), (Object) e2.getMessage())) {
                return e;
            }
    ...
    public static final boolean isArtificial(StackTraceElement stackTraceElement) {
        return StringsKt.startsWith$default(stackTraceElement.getClassName(), "\b\b\b", false, 2, null);
    }
