...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelLimitedFlowMerge(Iterable iterable, CoroutineContext coroutineContext, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(iterable, coroutineContext, i);
    }
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        for (Flow channelLimitedFlowMerge$collectTo$$inlined$forEach$lambda$1 : this.flows) {
            BuildersKt__Builders_commonKt.launch$default(producerScope, null, null, new ChannelLimitedFlowMerge$collectTo$$inlined$forEach$lambda$1(channelLimitedFlowMerge$collectTo$$inlined$forEach$lambda$1, null, producerScope, sendingCollector), 3, null);
        }
