...
public final class DownstreamExceptionElement implements Element {
    public static final Key Key = new Key(null);
    public final Throwable e;
    private final kotlin.coroutines.CoroutineContext.Key<?> key = Key;
    ...
    /* compiled from: SafeCollector.kt */
    public static final class Key implements kotlin.coroutines.CoroutineContext.Key<DownstreamExceptionElement> {
        private Key() {
        }
    ...
    public <E extends Element> E get(kotlin.coroutines.CoroutineContext.Key<E> key2) {
        return DefaultImpls.get(this, key2);
    }

    public CoroutineContext minusKey(kotlin.coroutines.CoroutineContext.Key<?> key2) {
