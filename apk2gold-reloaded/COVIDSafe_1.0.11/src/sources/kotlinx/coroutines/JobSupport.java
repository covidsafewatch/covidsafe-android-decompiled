...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final boolean addLastAtomic(Object obj, NodeList nodeList, JobNode<?> jobNode) {
        ...
        CondAddOp jobSupport$addLastAtomic$$inlined$addLastIf$1 = new JobSupport$addLastAtomic$$inlined$addLastIf$1(lockFreeLinkedListNode2, lockFreeLinkedListNode2, this, obj);
        do {
    ...
    public /* synthetic */ boolean cancel(Throwable th) {
        Throwable th2;
        if (th != null) {
            CancellationException cancellationException$default = toCancellationException$default(this, th, null, 1, null);
