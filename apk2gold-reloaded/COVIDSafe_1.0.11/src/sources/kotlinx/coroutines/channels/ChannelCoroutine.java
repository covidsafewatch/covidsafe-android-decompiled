...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public /* synthetic */ void cancel() {
        ...
        String str = null;
        cancelInternal(new JobCancellationException(jobSupport.cancellationExceptionMessage(), null, jobSupport));
    }
    ...
    public final void cancel(CancellationException cancellationException) {
        ...
        if (cancellationException != null) {
            ...
            JobSupport jobSupport = this;
            String str = null;
            th = new JobCancellationException(jobSupport.cancellationExceptionMessage(), null, jobSupport);
        }
        cancelInternal(th);
    }
