...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
                ...
                if (!getChannel().enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            continuation2.resumeWith(Result.m4constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            continuation3.resumeWith(Result.m4constructorimpl(boxBoolean2));
                        } else {
                            Continuation continuation4 = cancellableContinuation;
                            Throwable receiveException = closed.getReceiveException();
                            Companion companion3 = Result.Companion;
                            continuation4.resumeWith(Result.m4constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                ...
                Companion companion = Result.Companion;
                continuation.resumeWith(Result.m4constructorimpl(null));
            } else if (this.receiveMode == 2) {
                Continuation continuation2 = this.cont;
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m1016boximpl(ValueOrClosed.m1017constructorimpl(new Closed(closed.closeCause)));
                Companion companion3 = Result.Companion;
                continuation2.resumeWith(Result.m4constructorimpl(r3));
            } else {
                Continuation continuation3 = this.cont;
                Throwable receiveException = closed.getReceiveException();
                Companion companion4 = Result.Companion;
                continuation3.resumeWith(Result.m4constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    private static final class ReceiveHasNext<E> extends Receive<E> {
        ...
        public Symbol tryResumeReceive(E e, PrepareOp prepareOp) {
            boolean z = true;
            Object tryResume = this.cont.tryResume(Boolean.valueOf(true), prepareOp != null ? prepareOp.desc : null);
            if (tryResume == null) {
                return null;
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
            ...
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        ContinuationKt.startCoroutine(function2, ValueOrClosed.m1016boximpl(ValueOrClosed.m1017constructorimpl(new Closed(closed.closeCause))), this.select.getCompletion());
                    }
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            CondAddOp abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 = new AbstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1(lockFreeLinkedListNode, lockFreeLinkedListNode, this);
            do {
    ...
    public final Object receiveOrClosed(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        ...
        if (pollInternal instanceof Closed) {
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            obj = ValueOrClosed.m1017constructorimpl(new Closed(((Closed) pollInternal).closeCause));
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r1 = InlineList.m1035constructorimpl$default(null, 1, null);
            while (true) {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1016boximpl(ValueOrClosed.m1017constructorimpl(new Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
            }
        } else if (i == 2) {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            if (z) {
                obj2 = ValueOrClosed.m1017constructorimpl(new Closed(((Closed) obj).closeCause));
            } else {
                ...
                if (!enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            Companion companion = Result.Companion;
                            continuation2.resumeWith(Result.m4constructorimpl(resumeValue));
                            break;
                        }
                    } else {
