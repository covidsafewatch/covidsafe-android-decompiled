...
public final class SegmentedByteString extends ByteString {
    ...
    public void write$okio(Buffer buffer, int i, int i2) {
        ...
        while (i < i4) {
            ...
            int i6 = getDirectory$okio()[((Object[]) getSegments$okio()).length + segment] + (i - i3);
    ...
    public boolean rangeEquals(int i, ByteString byteString, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            if (!byteString.rangeEquals(i2, getSegments$okio()[segment], getDirectory$okio()[((Object[]) getSegments$okio()).length + segment] + (i - i4), min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public boolean rangeEquals(int i, byte[] bArr, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            int i6 = getDirectory$okio()[segment] - i4;
            int min = Math.min(i5, i6 + i4) - i;
            if (!Util.arrayRangeEquals(getSegments$okio()[segment], getDirectory$okio()[((Object[]) getSegments$okio()).length + segment] + (i - i4), bArr, i2, min)) {
                return false;
            }
            i2 += min;
            i += min;
