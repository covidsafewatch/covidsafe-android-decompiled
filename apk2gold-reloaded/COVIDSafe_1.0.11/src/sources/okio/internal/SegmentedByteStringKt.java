...
public final class SegmentedByteStringKt {
    ...
    public static final void forEachSegment(SegmentedByteString segmentedByteString, int i, int i2, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        ...
        while (i < i2) {
            ...
            function3.invoke(segmentedByteString.getSegments$okio()[segment], Integer.valueOf(segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length + segment] + (i - i3)), Integer.valueOf(min));
            i += min;
            segment++;
        }
    }
    ...
    public static final ByteString commonSubstring(SegmentedByteString segmentedByteString, int i, int i2) {
        ...
        if (i >= 0) {
            ...
            if (i2 <= segmentedByteString.size()) {
                ...
                sb2.append(i2);
                sb2.append(" > length(");
                sb2.append(segmentedByteString.size());
                sb2.append(')');
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, ByteString byteString, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            int i6 = segmentedByteString.getDirectory$okio()[segment] - i4;
            int min = Math.min(i5, i6 + i4) - i;
            if (!byteString.rangeEquals(i2, segmentedByteString.getSegments$okio()[segment], segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length + segment] + (i - i4), min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            int i6 = segmentedByteString.getDirectory$okio()[segment] - i4;
            int min = Math.min(i5, i6 + i4) - i;
            if (!Util.arrayRangeEquals(segmentedByteString.getSegments$okio()[segment], segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length + segment] + (i - i4), bArr, i2, min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final void commonWrite(SegmentedByteString segmentedByteString, Buffer buffer, int i, int i2) {
        ...
        while (i < i4) {
            ...
            int i6 = segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length + segment] + (i - i3);
