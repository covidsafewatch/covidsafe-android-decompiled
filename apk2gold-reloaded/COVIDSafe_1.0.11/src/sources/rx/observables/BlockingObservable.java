...
public final class BlockingObservable<T> {
    ...
    public void forEach(final Action1<? super T> action1) {
        ...
        BlockingUtils.awaitForComplete(countDownLatch, this.o.subscribe((Subscriber<? super T>) new Subscriber<T>() {
    ...
    public void subscribe(Observer<? super T> observer) {
        ...
        Subscription subscribe = this.o.subscribe((Subscriber<? super T>) new Subscriber<T>() {
            public void onNext(T t) {
    ...
    public void subscribe(Subscriber<? super T> subscriber) {
        ...
        this.o.subscribe((Subscriber<? super T>) r2);
        while (true) {
            try {
