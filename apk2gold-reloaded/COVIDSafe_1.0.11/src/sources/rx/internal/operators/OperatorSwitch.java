...
public final class OperatorSwitch<T> implements Operator<T, Observable<? extends T>> {
    ...
    static final class SwitchSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0054, code lost:
            r1 = (rx.internal.operators.OperatorSwitch.InnerSubscriber) r9.poll();
            r2 = rx.internal.operators.NotificationLite.getValue(r9.poll());
         */
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x006c, code lost:
            if (r10.get() != rx.internal.operators.OperatorSwitch.InnerSubscriber.access$000(r1)) goto L_0x0032;
         */
