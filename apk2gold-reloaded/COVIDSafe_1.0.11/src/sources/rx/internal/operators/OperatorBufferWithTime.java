...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0018, code lost:
            rx.exceptions.Exceptions.throwOrReport(r0, (rx.Observer<?>) r2);
         */
        ...
        public void emit() {
            ...
            L_0x0007:
                ...
                monitor-exit(r2)     // Catch:{ all -> 0x001c }
                rx.Subscriber<? super java.util.List<T>> r1 = r2.child     // Catch:{ all -> 0x0017 }
                r1.onNext(r0)     // Catch:{ all -> 0x0017 }
                goto L_0x001b
            L_0x0017:
                r0 = move-exception
