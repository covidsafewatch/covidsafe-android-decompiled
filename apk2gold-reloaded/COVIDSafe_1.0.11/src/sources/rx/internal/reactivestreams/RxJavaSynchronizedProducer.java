...
public final class RxJavaSynchronizedProducer implements Producer, Subscription {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0026, code lost:
        r3.unsubscribed = true;
        r3.subscription.cancel();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void unsubscribe() {
        /*
            ...
            monitor-enter(r3)
            boolean r0 = r3.unsubscribed     // Catch:{ all -> 0x002e }
            if (r0 == 0) goto L_0x000b
            monitor-exit(r3)     // Catch:{ all -> 0x002e }
            return
        L_0x000b:
            boolean r0 = r3.emitting     // Catch:{ all -> 0x002e }
            if (r0 == 0) goto L_0x0022
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x002e }
            r1 = 4
            r0.<init>(r1)     // Catch:{ all -> 0x002e }
            r3.requests = r0     // Catch:{ all -> 0x002e }
            r1 = 0
            java.lang.Long r1 = java.lang.Long.valueOf(r1)     // Catch:{ all -> 0x002e }
            r0.add(r1)     // Catch:{ all -> 0x002e }
            monitor-exit(r3)     // Catch:{ all -> 0x002e }
            return
        L_0x0022:
            r0 = 1
            r3.emitting = r0     // Catch:{ all -> 0x002e }
            monitor-exit(r3)     // Catch:{ all -> 0x002e }
            r3.unsubscribed = r0
            org.reactivestreams.Subscription r0 = r3.subscription
            r0.cancel()
            goto L_0x0031
        L_0x002e:
            r0 = move-exception
        ...
        L_0x0031:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.internal.reactivestreams.RxJavaSynchronizedProducer.unsubscribe():void");
    }
}
