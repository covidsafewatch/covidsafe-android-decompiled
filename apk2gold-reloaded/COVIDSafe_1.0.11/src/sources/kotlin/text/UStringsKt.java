...
public final class UStringsKt {
    ...
    public static final String m951toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m953toStringolVBNx4(short s, int i) {
    ...
    public static final String m952toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m950toStringJSWoG40(long j, int i) {
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m296unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m132unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m201unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m132unboximpl();
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m132unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m89constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m249boximpl(UShort.m255constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m89constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m315uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m89constructorimpl(i2 * r5);
            int r8 = UInt.m89constructorimpl(UInt.m89constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m158constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m317ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m158constructorimpl(j2 * r9);
            long r4 = ULong.m158constructorimpl(ULong.m158constructorimpl(((long) UInt.m89constructorimpl(digitOf)) & 4294967295L) + r11);
