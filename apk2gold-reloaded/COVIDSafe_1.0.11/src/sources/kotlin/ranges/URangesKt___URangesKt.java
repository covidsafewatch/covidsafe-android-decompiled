...
class URangesKt___URangesKt {
    ...
    public static final UIntRange m944untilKr8caGY(byte b, byte b2) {
        ...
        return new UIntRange(UInt.m89constructorimpl(b & 255), UInt.m89constructorimpl(UInt.m89constructorimpl(b3) - 1), null);
    }
    ...
    public static final ULongRange m945untileb3DHEI(long j, long j2) {
        ...
        ULongRange uLongRange = new ULongRange(j, ULong.m158constructorimpl(j2 - ULong.m158constructorimpl(((long) 1) & 4294967295L)), null);
        return uLongRange;
    }
    ...
    public static final UIntRange m942until5PvTz6A(short s, short s2) {
        ...
        return new UIntRange(UInt.m89constructorimpl(s & UShort.MAX_VALUE), UInt.m89constructorimpl(UInt.m89constructorimpl(s3) - 1), null);
    }
    ...
    public static final int m926coerceInWZ9TVnA(int i, int i2, int i3) {
        if (UnsignedKt.uintCompare(i2, i3) > 0) {
            ...
            sb.append(UInt.m126toStringimpl(i3));
            sb.append(" is less than minimum ");
            sb.append(UInt.m126toStringimpl(i2));
            sb.append('.');
    ...
    public static final long m928coerceInsambcqE(long j, long j2, long j3) {
        if (UnsignedKt.ulongCompare(j2, j3) > 0) {
            StringBuilder sb = new StringBuilder();
            sb.append("Cannot coerce value to an empty range: maximum ");
            sb.append(ULong.m195toStringimpl(j3));
            sb.append(" is less than minimum ");
            sb.append(ULong.m195toStringimpl(j2));
            sb.append('.');
            throw new IllegalArgumentException(sb.toString());
    ...
    public static final byte m927coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("Cannot coerce value to an empty range: maximum ");
        sb.append(UByte.m57toStringimpl(b3));
        sb.append(" is less than minimum ");
        sb.append(UByte.m57toStringimpl(b2));
        sb.append('.');
        throw new IllegalArgumentException(sb.toString());
    }
    ...
    public static final short m925coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("Cannot coerce value to an empty range: maximum ");
        sb.append(UShort.m290toStringimpl(s3));
        sb.append(" is less than minimum ");
        sb.append(UShort.m290toStringimpl(s2));
        sb.append('.');
        throw new IllegalArgumentException(sb.toString());
    }
    ...
    public static final int m929coerceInwuiCnnA(int i, ClosedRange<UInt> closedRange) {
        ...
        if (!closedRange.isEmpty()) {
            if (UnsignedKt.uintCompare(i, ((UInt) closedRange.getStart()).m132unboximpl()) < 0) {
                i = ((UInt) closedRange.getStart()).m132unboximpl();
            } else if (UnsignedKt.uintCompare(i, ((UInt) closedRange.getEndInclusive()).m132unboximpl()) > 0) {
                i = ((UInt) closedRange.getEndInclusive()).m132unboximpl();
            }
            return i;
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static final long m924coerceInJPwROB0(long j, ClosedRange<ULong> closedRange) {
        ...
        if (!closedRange.isEmpty()) {
            if (UnsignedKt.ulongCompare(j, ((ULong) closedRange.getStart()).m201unboximpl()) < 0) {
                j = ((ULong) closedRange.getStart()).m201unboximpl();
            } else if (UnsignedKt.ulongCompare(j, ((ULong) closedRange.getEndInclusive()).m201unboximpl()) > 0) {
                j = ((ULong) closedRange.getEndInclusive()).m201unboximpl();
            }
            return j;
        }
        StringBuilder sb = new StringBuilder();
