...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m913containsWZ4Q5Ns(((UInt) comparable).m132unboximpl());
    }
    ...
    public boolean m913containsWZ4Q5Ns(int i) {
    ...
    public String toString() {
        ...
        sb.append(UInt.m126toStringimpl(getFirst()));
        sb.append("..");
        sb.append(UInt.m126toStringimpl(getLast()));
        return sb.toString();
    }
}
