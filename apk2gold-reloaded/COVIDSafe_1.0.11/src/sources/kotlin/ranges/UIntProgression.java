...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m912fromClosedRangeNkh28Cs(int i, int i2, int i3) {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m898getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m126toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m126toStringimpl(this.last));
            sb.append(str);
            i = this.step;
        } else {
            sb = new StringBuilder();
