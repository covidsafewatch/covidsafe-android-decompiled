...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public TimeMark m955plusLRDsOJo(double d) {
            LongTimeMark longTimeMark = new LongTimeMark(this.startedAt, this.timeSource, Duration.m983plusLRDsOJo(this.offset, d), null);
            return longTimeMark;
        }
    }
    ...
    public TimeMark markNow() {
        LongTimeMark longTimeMark = new LongTimeMark(read(), this, Duration.Companion.getZERO(), null);
        return longTimeMark;
    }
}
