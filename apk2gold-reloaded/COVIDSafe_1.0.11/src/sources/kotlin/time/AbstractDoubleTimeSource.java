...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark extends TimeMark {
        ...
        public double elapsedNow() {
            return Duration.m982minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo reason: not valid java name */
        public TimeMark m954plusLRDsOJo(double d) {
            DoubleTimeMark doubleTimeMark = new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m983plusLRDsOJo(this.offset, d), null);
            return doubleTimeMark;
        }
    }
    ...
    public TimeMark markNow() {
        DoubleTimeMark doubleTimeMark = new DoubleTimeMark(read(), this, Duration.Companion.getZERO(), null);
        return doubleTimeMark;
    }
}
