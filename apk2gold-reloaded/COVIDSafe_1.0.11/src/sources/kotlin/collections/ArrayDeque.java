...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public boolean addAll(int i, Collection<? extends E> collection) {
        ...
        if (i < ((size() + 1) >> 1)) {
            ...
            if (access$positiveMod2 < i2) {
                ...
                if (length >= access$positiveMod2 - i2) {
            ...
            int i4 = access$positiveMod2 + size2;
            if (access$positiveMod2 < access$positiveMod) {
                int i5 = size2 + access$positiveMod;
                ...
                if (i4 >= objArr11.length) {
                    ...
                    ArraysKt.copyInto(objArr12, objArr12, i4, access$positiveMod2, objArr12.length - size2);
                }
            }
    ...
    private final boolean filterInPlace(kotlin.jvm.functions.Function1<? super E, java.lang.Boolean> r12) {
        ...
        L_0x0054:
            ...
            kotlin.collections.ArraysKt.fill(r12, r5, r3, r0)
            goto L_0x00bc
        L_0x005c:
            int r4 = r11.head
            java.lang.Object[] r6 = r11.elementData
