...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r8, boolean r9) {
            ...
            L_0x0025:
                ...
                int r6 = androidx.core.R.id.actions
                r0.addView(r6, r5)
                int r4 = r4 + 1
                goto L_0x0025
            L_0x0039:
            ...
            L_0x003d:
                r2 = 8
            L_0x003f:
                int r9 = androidx.core.R.id.actions
                r0.setViewVisibility(r9, r2)
                int r9 = androidx.core.R.id.action_divider
                r0.setViewVisibility(r9, r2)
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    if (size != this.mMessages.size() - 1) {
                        spannableStringBuilder.insert(0, StringUtils.EOL);
                    }
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        boolean z5 = z;
        if (VERSION.SDK_INT < 23) {
            Action action3 = new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, z5);
            return action3;
        } else if (action.getIcon() != null || action2.icon == 0) {
            if (action.getIcon() != null) {
                iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
            }
            Action action4 = new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, z5);
            return action4;
        } else {
            Action action5 = new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, z5);
            return action5;
        }
    }
