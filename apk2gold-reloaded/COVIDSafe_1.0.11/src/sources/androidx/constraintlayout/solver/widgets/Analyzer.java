...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        if (z3) {
            ...
            width = i15 + ((i11 == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i7);
        }
        int i16 = 1;
        if (i11 == 1) {
            ...
            while (it4.hasNext()) {
                ...
                if (i7 == i16) {
                    ...
                    i10 = i3;
                    i17 = Math.max(i17, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i11, z2, (i5 * i7) + i14));
                }
                it4 = it5;
                i3 = i10;
                i16 = 1;
            ...
            i8 = i3;
            int i18 = i17;
            i9 = (constraintWidget2.mBaseline.getResolutionNode().dependents.size() <= 0 || z3) ? i18 : i7 == 1 ? i18 + i6 : i18 - i5;
        } else {
            i8 = i3;
            i9 = 0;
        }
        ...
        if (!(constraintWidget2.mListAnchors[i4].mTarget == null || constraintWidget2.mListAnchors[i8].mTarget == null)) {
            ConstraintWidget parent = constraintWidget.getParent();
            if (constraintWidget2.mListAnchors[i4].mTarget.mOwner == parent && constraintWidget2.mListAnchors[i8].mTarget.mOwner == parent) {
                constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i11);
            }
        }
        return max;
