...
public final class EnterNumberFragment$phoneNumberTextWatcher$1 implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        String str = "enter_number_phone_number";
        Intrinsics.checkExpressionValueIsNotNull(editText, str);
        InputFilter[] filters = editText.getFilters();
        if (editable != null) {
            String obj = editable.toString();
            if (obj != null && StringsKt.startsWith$default(obj, "0", false, 2, null)) {
                integer++;
            }
        }
        ...
        if (array != null) {
            editText2.setFilters((InputFilter[]) ArraysKt.plus(array, (Object) new LengthFilter(integer)));
