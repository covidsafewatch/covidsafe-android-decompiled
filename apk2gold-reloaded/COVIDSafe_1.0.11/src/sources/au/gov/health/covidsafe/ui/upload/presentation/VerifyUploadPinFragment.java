...
public final class VerifyUploadPinFragment extends PagerChildFragment {
    ...
    public ContinueLayout getUploadButtonLayout() {
        return new ContinueLayout(R.string.action_verify_upload_pin, new VerifyUploadPinFragment$getUploadButtonLayout$1(this));
    }
    ...
    public final void navigateToRegister() {
        BaseFragment.navigateTo$default(this, VerifyUploadPinFragmentDirections.Companion.actionVerifyUploadPinFragmentToEnterNumberFragment().getActionId(), BundleKt.bundleOf(TuplesKt.to("destination_id", Integer.valueOf(R.id.action_enterPinFragment_to_uploadStepFourFragment))), null, 4, null);
    }

    public final void navigateToNextPage() {
        BaseFragment.navigateTo$default(this, R.id.action_verifyUploadPinFragment_to_uploadFinishedFragment, null, null, 6, null);
    }
