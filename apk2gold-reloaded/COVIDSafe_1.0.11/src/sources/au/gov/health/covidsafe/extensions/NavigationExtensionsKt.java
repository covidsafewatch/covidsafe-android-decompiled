...
public final class NavigationExtensionsKt {
    public static final void navigateTo(Fragment fragment, int i, Bundle bundle, Extras extras) {
    ...
    public static /* synthetic */ void navigateTo$default(Fragment fragment, int i, Bundle bundle, Extras extras, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            bundle = null;
        }
        if ((i2 & 4) != 0) {
