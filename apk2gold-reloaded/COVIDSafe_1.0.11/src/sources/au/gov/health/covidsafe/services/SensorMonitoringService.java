...
public final class SensorMonitoringService extends Service implements SensorEventListener {
    ...
    public void onCreate() {
        ...
        if (systemService != null) {
            ...
            if (defaultSensor2 != null) {
                ...
                CentralLog.Companion.d(str2, "Light sensor not available");
            }
            CentralLog.Companion.d(str2, "SensorMonitoringService started");
            return;
        }
    ...
    public void onAccuracyChanged(Sensor sensor, int i) {
        au.gov.health.covidsafe.logging.CentralLog.Companion companion = CentralLog.Companion;
        StringBuilder sb = new StringBuilder();
        sb.append("Sensor accuracy changed! ");
        sb.append(sensor);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        String str = "event.sensor";
        Intrinsics.checkExpressionValueIsNotNull(sensor, str);
        ...
        if (type == 5) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(sensor2, str);
