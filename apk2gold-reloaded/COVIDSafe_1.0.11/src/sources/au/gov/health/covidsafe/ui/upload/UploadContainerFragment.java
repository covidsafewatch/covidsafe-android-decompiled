...
public final class UploadContainerFragment extends Fragment implements PagerContainer {
    ...
    public void refreshButton(UploadButtonLayout uploadButtonLayout) {
        ...
        if (uploadButtonLayout instanceof ContinueLayout) {
            ...
            ((Button) _$_findCachedViewById(R.id.upload_continue)).setText(((ContinueLayout) uploadButtonLayout).getButtonText());
