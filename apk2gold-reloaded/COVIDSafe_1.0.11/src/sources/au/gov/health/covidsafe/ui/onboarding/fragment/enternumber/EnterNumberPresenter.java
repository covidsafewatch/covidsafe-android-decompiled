...
public final class EnterNumberPresenter implements LifecycleObserver {
    ...
    public final void requestOTP$app_release(String str) {
        ...
        if (validateAuNumber$app_release(str)) {
            if (StringsKt.startsWith$default(str, "0", false, 2, null)) {
            ...
            sb.append(this.enterNumberFragment.getResources().getString(R.string.enter_number_prefix));
            sb.append(str);
            Preference.INSTANCE.putPhoneNumber(TracerApp.Companion.getAppContext(), sb.toString());
    ...
    private final void makeOTPCall(String str) {
        if (this.enterNumberFragment.getActivity() != null) {
            ...
            String str2 = "enterNumberFragment.requireContext()";
            Intrinsics.checkExpressionValueIsNotNull(requireContext, str2);
            ...
            Intrinsics.checkExpressionValueIsNotNull(requireContext2, str2);
            ...
            Intrinsics.checkExpressionValueIsNotNull(requireContext3, str2);
            GetOtpParams getOtpParams = new GetOtpParams(str, deviceID, postCode, age, preference3.getName(requireContext3));
            getOnboardingOtp2.invoke(getOtpParams, new EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$1(this, str), new EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$2(this, str));
        }
    }
    ...
    public final boolean validateAuNumber$app_release(String str) {
        ...
        if (str != null && StringsKt.startsWith$default(str, "0", false, 2, null)) {
            integer++;
        }
