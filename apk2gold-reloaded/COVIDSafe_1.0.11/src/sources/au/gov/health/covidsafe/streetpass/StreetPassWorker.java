...
import au.gov.health.covidsafe.streetpass.Work.OnWorkTimeoutListener;
...
public final class StreetPassWorker {
    ...
    public final class StreetPassGattCallback extends BluetoothGattCallback {
        ...
        public void onServicesDiscovered(BluetoothGatt bluetoothGatt, int i) {
            ...
            sb2.append("onServicesDiscovered received: BluetoothGatt.GATT_SUCCESS - ");
            sb2.append(i);
            ...
            sb3.append(bluetoothGatt.getServices().size());
            sb3.append(" services on ");
            ...
            if (service != null) {
                ...
                if (characteristic != null) {
                    ...
                    sb4.append("Attempt to read characteristic of our service on ");
                    ...
                    sb5.append(" does not have our characteristic");
            ...
            if (service == null) {
                ...
                sb6.append(device5.getAddress());
                sb6.append(" does not have our service");
        ...
        public void onCharacteristicRead(BluetoothGatt bluetoothGatt, BluetoothGattCharacteristic bluetoothGattCharacteristic, int i) {
            ...
            if (i != 0) {
                ...
                BluetoothDevice device = bluetoothGatt.getDevice();
                Intrinsics.checkExpressionValueIsNotNull(device, str2);
                ...
                BluetoothDevice device2 = bluetoothGatt.getDevice();
                Intrinsics.checkExpressionValueIsNotNull(device2, str2);
                sb3.append(device2.getAddress());
                sb3.append(str);
                ...
                if (Intrinsics.areEqual((Object) bluetoothGattCharacteristic.getUuid(), (Object) this.this$0.serviceUUID)) {
                    ...
                    try {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(createReadRequestPayload.getV(), createReadRequestPayload.getMsg(), createReadRequestPayload.getOrg(), new PeripheralDevice(createReadRequestPayload.getModelP(), this.work.getDevice().getAddress()), TracerApp.Companion.asCentralDevice(), this.work.getConnectable().getRssi(), this.work.getConnectable().getTransmissionPower());
                        Utils.INSTANCE.broadcastStreetPassReceived(this.this$0.getContext(), connectionRecord);
                    } catch (Throwable th) {
                        Companion companion6 = CentralLog.Companion;
                        String access$getTAG$p5 = this.this$0.TAG;
                        StringBuilder sb5 = new StringBuilder();
                        sb5.append("Failed to de-serialize request payload object - ");
                        sb5.append(th.getMessage());
                        companion6.e(access$getTAG$p5, sb5.toString());
                    }
                }
            ...
            if (Utils.INSTANCE.bmValid(this.this$0.getContext())) {
                String str3 = "AU_DTA";
                WriteRequestPayload writeRequestPayload = new WriteRequestPayload(1, TracerApp.Companion.thisDeviceMsg(), str3, TracerApp.Companion.asCentralDevice().getModelC(), this.work.getConnectable().getRssi(), this.work.getConnectable().getTransmissionPower());
                bluetoothGattCharacteristic.setValue(writeRequestPayload.getPayload());
                ...
                BluetoothDevice device3 = bluetoothGatt.getDevice();
                Intrinsics.checkExpressionValueIsNotNull(device3, str2);
                sb6.append(device3.getAddress());
                sb6.append(str);
                sb6.append(writeCharacteristic);
                companion7.i(access$getTAG$p6, sb6.toString());
                return;
            }
            ...
            BluetoothDevice device4 = bluetoothGatt.getDevice();
            Intrinsics.checkExpressionValueIsNotNull(device4, str2);
            sb7.append(device4.getAddress());
            companion8.i(access$getTAG$p7, sb7.toString());
            endWorkConnection(bluetoothGatt);
        }
