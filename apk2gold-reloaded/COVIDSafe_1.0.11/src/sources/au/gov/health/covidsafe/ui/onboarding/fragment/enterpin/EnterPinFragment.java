...
public final class EnterPinFragment extends PagerChildFragment {
    ...
    private Integer stepProgress = Integer.valueOf(3);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            String str = "progress";
            setStepProgress(arguments.containsKey(str) ? Integer.valueOf(arguments.getInt(str)) : null);
        ...
        ViewExtensionsKt.toHyperlink$default(textView2, null, new EnterPinFragment$onViewCreated$2(this), 1, null);
        ...
        ViewExtensionsKt.toHyperlink$default(textView3, null, new EnterPinFragment$onViewCreated$3(this), 1, null);
        startTimer();
    }
    ...
    public void onPause() {
        super.onPause();
        ((PinInputView) _$_findCachedViewById(R.id.pin)).setOnPinChanged(null);
    }

    private final void startTimer() {
        EnterPinFragment$startTimer$1 enterPinFragment$startTimer$1 = new EnterPinFragment$startTimer$1(this, ((long) 1000) * this.COUNTDOWN_DURATION, 1000);
        CountDownTimer countDownTimer = enterPinFragment$startTimer$1;
    ...
    public final void showGenericError() {
        ...
        this.alertDialog = new Builder(getActivity()).setMessage(R.string.generic_error).setIcon(17301543).setPositiveButton(17039379, null).show();
    }
    ...
    public ContinueLayout getUploadButtonLayout() {
        return new ContinueLayout(R.string.enter_pin_button, new EnterPinFragment$getUploadButtonLayout$1(this));
    }
}
