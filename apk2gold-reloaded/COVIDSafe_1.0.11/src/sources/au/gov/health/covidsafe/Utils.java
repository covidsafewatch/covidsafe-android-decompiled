...
import au.gov.health.covidsafe.services.BluetoothMonitoringService.Command;
...
public final class Utils {
    ...
    public final void startBluetoothMonitoringService(Context context) {
        ...
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_START.getIndex());
    ...
    public final void scheduleBMUpdateCheck(Context context, long j) {
        ...
        Intent intent = new Intent(context, BluetoothMonitoringService.class);
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_UPDATE_BM.getIndex());
    ...
    public final void stopBluetoothMonitoringService(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intent intent = new Intent(context, BluetoothMonitoringService.class);
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_STOP.getIndex());
    ...
    public final void cancelNextScan(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intent intent = new Intent(context, BluetoothMonitoringService.class);
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_SCAN.getIndex());
    ...
    public final void cancelNextAdvertise(Context context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intent intent = new Intent(context, BluetoothMonitoringService.class);
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_ADVERTISE.getIndex());
    ...
    public final void scheduleNextHealthCheck(Context context, long j) {
        ...
        cancelNextHealthCheck(context);
        Intent intent = new Intent(context, BluetoothMonitoringService.class);
        intent.putExtra(BluetoothMonitoringService.COMMAND_KEY, Command.ACTION_SELF_CHECK.getIndex());
    ...
    public final void storeBroadcastMessage(Context context, String str) {
        ...
        FilesKt.writeText$default(new File(context != null ? context.getFilesDir() : null, str2), str, null, 2, null);
    }
    ...
    public final String retrieveBroadcastMessage(Context context) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("fetched broadcastmessage from file:  ");
