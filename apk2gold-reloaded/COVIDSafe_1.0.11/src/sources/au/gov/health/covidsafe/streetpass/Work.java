...
import au.gov.health.covidsafe.streetpass.StreetPassWorker.StreetPassGattCallback;
...
public final class Work implements Comparable<Work> {
    ...
    public final void startWork(Context context, StreetPassGattCallback streetPassGattCallback) {
