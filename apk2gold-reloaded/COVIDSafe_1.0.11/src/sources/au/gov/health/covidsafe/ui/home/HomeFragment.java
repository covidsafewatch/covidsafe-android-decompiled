...
public final class HomeFragment extends BaseFragment implements PermissionCallbacks {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        String str = "home_header_label_setup_…mplete_disclaimer_content";
    ...
    public void onPause() {
        ...
        ((Button) _$_findCachedViewById(R.id.home_been_tested_button)).setOnClickListener(null);
        ((ExternalLinkCard) _$_findCachedViewById(R.id.home_setup_complete_share)).setOnClickListener(null);
        ((ExternalLinkCard) _$_findCachedViewById(R.id.home_setup_complete_news)).setOnClickListener(null);
        ((ExternalLinkCard) _$_findCachedViewById(R.id.home_setup_complete_app)).setOnClickListener(null);
    ...
    public final void refreshSetupCompleteOrIncompleteUi() {
        String str = "content_setup_incomplete_group";
        String str2 = "content_setup_complete";
        String str3 = "header_setup_incomplete";
        String str4 = "header_setup_complete";
        if (allPermissionsEnabled()) {
            Group group = (Group) _$_findCachedViewById(R.id.header_setup_complete);
            Intrinsics.checkExpressionValueIsNotNull(group, str4);
        ...
        Intrinsics.checkExpressionValueIsNotNull(group5, str4);
        ...
        Intrinsics.checkExpressionValueIsNotNull(group7, str2);
        group7.setVisibility(8);
        Group group8 = (Group) _$_findCachedViewById(R.id.content_setup_incomplete_group);
        Intrinsics.checkExpressionValueIsNotNull(group8, str);
    ...
    private final void updateBlueToothStatus() {
        Boolean isBlueToothEnabled = PermissionExtensionsKt.isBlueToothEnabled(this);
        String str = "bluetooth_card_view";
        if (isBlueToothEnabled != null) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(permissionStatusCard, str);
        ...
        Intrinsics.checkExpressionValueIsNotNull(permissionStatusCard2, str);
        permissionStatusCard2.setVisibility(8);
    }

    private final void updatePushNotificationStatus() {
        Boolean isPushNotificationEnabled = PermissionExtensionsKt.isPushNotificationEnabled(this);
        String str = "push_card_view";
    ...
    public void onPermissionsDenied(int i, List<String> list) {
        ...
        if (i == 345) {
            ...
            if (EasyPermissions.somePermissionPermanentlyDenied(fragment, CollectionsKt.listOf("android.permission.ACCESS_FINE_LOCATION"))) {
                new Builder(fragment).build().show();
            }
        }
    }
