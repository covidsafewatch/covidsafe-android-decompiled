...
final class UploadContainerFragment$showLoading$1 extends Lambda implements Function1<ProgressParams, Unit> {
    public static final UploadContainerFragment$showLoading$1 INSTANCE = new UploadContainerFragment$showLoading$1();

    UploadContainerFragment$showLoading$1() {
        super(1);
    }
