...
final class UploadContainerFragment$refreshButton$1 implements OnClickListener {
    ...
    public final void onClick(View view) {
        Function0 buttonListener = ((ContinueLayout) this.$uploadButtonLayout).getButtonListener();
