...
public abstract class StreetPassRecordDatabase extends RoomDatabase {
    ...
    public static final class Companion {
        ...
        public final StreetPassRecordDatabase getDatabase(Context context) {
            ...
            synchronized (this) {
                RoomDatabase build = Room.databaseBuilder(context, StreetPassRecordDatabase.class, "record_database").addMigrations(StreetPassRecordDatabase.MIGRATION_1_2).build();
