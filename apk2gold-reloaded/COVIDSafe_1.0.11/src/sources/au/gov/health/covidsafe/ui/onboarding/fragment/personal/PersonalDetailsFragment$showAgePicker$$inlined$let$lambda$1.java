...
final class PersonalDetailsFragment$showAgePicker$$inlined$let$lambda$1 implements OnClickListener {
    final /* synthetic */ List $ages;
    final /* synthetic */ IntRef $selected;
    final /* synthetic */ PersonalDetailsFragment this$0;

    PersonalDetailsFragment$showAgePicker$$inlined$let$lambda$1(List list, IntRef intRef, PersonalDetailsFragment personalDetailsFragment) {
        this.$ages = list;
