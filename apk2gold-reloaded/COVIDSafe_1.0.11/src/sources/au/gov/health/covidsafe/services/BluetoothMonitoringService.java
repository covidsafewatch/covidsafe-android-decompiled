...
public final class BluetoothMonitoringService extends LifecycleService implements CoroutineScope {
    ...
    public final class BluetoothStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && Intrinsics.areEqual((Object) intent.getAction(), (Object) "android.bluetooth.adapter.action.STATE_CHANGED")) {
                ...
                String str = "this@BluetoothMonitoringService.applicationContext";
                String str2 = BluetoothMonitoringService.TAG;
                switch (intExtra) {
                    case 10:
                        CentralLog.Companion.d(str2, "BluetoothAdapter.STATE_OFF");
                        return;
                    case 11:
                        CentralLog.Companion.d(str2, "BluetoothAdapter.STATE_TURNING_ON");
                        return;
                    case 12:
                        CentralLog.Companion.d(str2, "BluetoothAdapter.STATE_ON");
                        ...
                        return;
                    case 13:
                        CentralLog.Companion.d(str2, "BluetoothAdapter.STATE_TURNING_OFF");
                        au.gov.health.covidsafe.notifications.NotificationTemplates.Companion companion = NotificationTemplates.Companion;
            ...
            if (Intrinsics.areEqual((Object) GATTKt.ACTION_RECEIVED_STREETPASS, (Object) intent.getAction())) {
                ...
                if (connectionRecord.getMsg().length() > 0) {
                    if (BluetoothMonitoringService.this.mBound) {
                        ...
                        sb2.append("Sensor values just before saving StreetPassRecord: proximity=");
    ...
    private final void setup() {
        ...
        if (systemService != null) {
            ...
            au.gov.health.covidsafe.receivers.PrivacyCleanerReceiver.Companion companion = PrivacyCleanerReceiver.Companion;
            ...
            Intrinsics.checkExpressionValueIsNotNull(applicationContext5, str);
    ...
    private final boolean isBluetoothEnabled() {
        BluetoothAdapter bluetoothAdapter = (BluetoothAdapter) LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new BluetoothMonitoringService$isBluetoothEnabled$bluetoothAdapter$2(this)).getValue();
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        au.gov.health.covidsafe.logging.CentralLog.Companion companion = CentralLog.Companion;
        String str = TAG;
        companion.i(str, "Service onStartCommand");
        ...
        if (!hasLocationPermissions() || !isBluetoothEnabled()) {
            ...
            au.gov.health.covidsafe.notifications.NotificationTemplates.Companion companion3 = NotificationTemplates.Companion;
            Context applicationContext = getApplicationContext();
            ...
            CentralLog.Companion.e(str, "Nothing in intent @ onStartCommand");
            CommandHandler commandHandler2 = this.commandHandler;
            if (commandHandler2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("commandHandler");
            }
    ...
    public final void runService(Command command) {
        ...
        if (!hasLocationPermissions() || !isBluetoothEnabled()) {
            ...
            sb3.append(hasLocationPermissions());
            sb3.append(" bluetooth: ");
            sb3.append(isBluetoothEnabled());
            companion2.i(str, sb3.toString());
            au.gov.health.covidsafe.notifications.NotificationTemplates.Companion companion3 = NotificationTemplates.Companion;
            Context applicationContext = getApplicationContext();
            Intrinsics.checkExpressionValueIsNotNull(applicationContext, str2);
            startForeground(771579, companion3.lackingThingsNotification(applicationContext, "COVIDSafe Updates"));
            return;
        }
        if (command != null) {
            switch (WhenMappings.$EnumSwitchMapping$0[command.ordinal()]) {
                case 1:
                    ...
                    Utils utils2 = Utils.INSTANCE;
                    Context applicationContext3 = getApplicationContext();
                    Intrinsics.checkExpressionValueIsNotNull(applicationContext3, str2);
        ...
        au.gov.health.covidsafe.logging.CentralLog.Companion companion4 = CentralLog.Companion;
        StringBuilder sb4 = new StringBuilder();
        sb4.append("Invalid command: ");
        sb4.append(command);
        sb4.append(". Nothing to do");
        companion4.i(str, sb4.toString());
    }
    ...
    private final void startScan() {
        ...
        if (isBluetoothEnabled) {
            ...
            if (!streetPassScanner2.isScanning()) {
                ...
                CentralLog.Companion.e(str, "Already scanning!");
            }
        } else {
            CentralLog.Companion.w(str, "Unable to start scan - bluetooth is off");
        }
    }
    ...
    private final void performHealthCheck() {
        ...
        String str2 = "COVIDSafe Updates";
        String str3 = "this.applicationContext";
        if (!hasLocationPermissions() || !isBluetoothEnabled()) {
            CentralLog.Companion.i(str, "no location permission");
            au.gov.health.covidsafe.notifications.NotificationTemplates.Companion companion2 = NotificationTemplates.Companion;
            Context applicationContext = getApplicationContext();
            Intrinsics.checkExpressionValueIsNotNull(applicationContext, str3);
            startForeground(771579, companion2.lackingThingsNotification(applicationContext, str2));
            return;
        }
        au.gov.health.covidsafe.notifications.NotificationTemplates.Companion companion3 = NotificationTemplates.Companion;
        Context applicationContext2 = getApplicationContext();
        Intrinsics.checkExpressionValueIsNotNull(applicationContext2, str3);
        startForeground(771579, companion3.getRunningNotification(applicationContext2, str2));
        setupService();
        CommandHandler commandHandler2 = this.commandHandler;
        String str4 = "commandHandler";
        if (commandHandler2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException(str4);
        }
        if (!commandHandler2.hasScanScheduled()) {
            CentralLog.Companion.w(str, "Missing Scan Schedule - rectifying");
            setupScanCycles();
        } else {
            CentralLog.Companion.w(str, "Scan Schedule present");
        }
        ...
        if (!commandHandler3.hasAdvertiseScheduled()) {
            CentralLog.Companion.w(str, "Missing Advertise Schedule - rectifying");
            setupAdvertisingCycles();
        } else {
            au.gov.health.covidsafe.logging.CentralLog.Companion companion4 = CentralLog.Companion;
            StringBuilder sb = new StringBuilder();
    ...
    public void onDestroy() {
        ...
        this.mBound = false;
        CentralLog.Companion.i(str, "BluetoothMonitoringService destroyed");
    }
    ...
    private final void unregisterReceivers() {
        ...
        try {
            ...
            CentralLog.Companion.w(str2, "streetPassReceiver is not registered?");
        }
        try {
            LocalBroadcastManager localBroadcastManager3 = this.localBroadcastManager;
            if (localBroadcastManager3 == null) {
            ...
            CentralLog.Companion.w(str2, "statusReceiver is not registered?");
        }
        try {
            unregisterReceiver(this.bluetoothStatusReceiver);
        } catch (Throwable unused3) {
            CentralLog.Companion.w(str2, "bluetoothStatusReceiver is not registered?");
        }
    }
}
