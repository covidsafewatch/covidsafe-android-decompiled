...
public final class UploadData extends UseCase<String, String> {
    ...
    public java.lang.Object run(java.lang.String r11, kotlin.coroutines.Continuation<? super au.gov.health.covidsafe.interactor.Either<? extends java.lang.Exception, java.lang.String>> r12) {
        /*
            ...
            r0 = r12
            au.gov.health.covidsafe.interactor.usecase.UploadData$run$1 r0 = (au.gov.health.covidsafe.interactor.usecase.UploadData$run$1) r0
            int r1 = r0.label
            ...
            goto L_0x0019
        L_0x0014:
            au.gov.health.covidsafe.interactor.usecase.UploadData$run$1 r0 = new au.gov.health.covidsafe.interactor.usecase.UploadData$run$1
            r0.<init>(r10, r12)
        L_0x0019:
            ...
            au.gov.health.covidsafe.interactor.usecase.UploadData r11 = (au.gov.health.covidsafe.interactor.usecase.UploadData) r11
        ...
        L_0x0051:
            ...
            au.gov.health.covidsafe.interactor.usecase.UploadData r6 = (au.gov.health.covidsafe.interactor.usecase.UploadData) r6
        ...
        L_0x006e:
            ...
            au.gov.health.covidsafe.Preference r12 = au.gov.health.covidsafe.Preference.INSTANCE
            android.content.Context r2 = r10.context
            java.lang.String r12 = r12.getEncrypterJWTToken(r2)
            if (r12 == 0) goto L_0x0127
            au.gov.health.covidsafe.interactor.usecase.UploadData$run$$inlined$let$lambda$1 r2 = new au.gov.health.covidsafe.interactor.usecase.UploadData$run$$inlined$let$lambda$1     // Catch:{ Exception -> 0x011a }
            r2.<init>(r12, r10, r0, r11)     // Catch:{ Exception -> 0x011a }
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch:{ Exception -> 0x011a }
            ...
            java.lang.Object r2 = r10.retryRetrofitCall(r2, r0)     // Catch:{ Exception -> 0x011a }
        ...
        L_0x0093:
            ...
            r11 = r10
        L_0x0096:
            retrofit2.Response r2 = (retrofit2.Response) r2     // Catch:{ Exception -> 0x0046 }
            if (r2 != 0) goto L_0x00a5
            au.gov.health.covidsafe.interactor.Failure r12 = new au.gov.health.covidsafe.interactor.Failure     // Catch:{ Exception -> 0x0046 }
            au.gov.health.covidsafe.interactor.usecase.UploadDataException$UploadDataIncorrectPinException r0 = au.gov.health.covidsafe.interactor.usecase.UploadDataException.UploadDataIncorrectPinException.INSTANCE     // Catch:{ Exception -> 0x0046 }
            r12.<init>(r0)     // Catch:{ Exception -> 0x0046 }
            au.gov.health.covidsafe.interactor.Either r12 = (au.gov.health.covidsafe.interactor.Either) r12     // Catch:{ Exception -> 0x0046 }
            goto L_0x0124
        L_0x00a5:
            boolean r7 = r2.isSuccessful()     // Catch:{ Exception -> 0x0046 }
            if (r7 == 0) goto L_0x00ed
            java.lang.Object r7 = r2.body()     // Catch:{ Exception -> 0x0046 }
            au.gov.health.covidsafe.networking.response.InitiateUploadResponse r7 = (au.gov.health.covidsafe.networking.response.InitiateUploadResponse) r7     // Catch:{ Exception -> 0x0046 }
            if (r7 == 0) goto L_0x00b8
            java.lang.String r7 = r7.getUploadLink()     // Catch:{ Exception -> 0x0046 }
            goto L_0x00b9
        L_0x00b8:
            r7 = 0
        L_0x00b9:
            r8 = r7
            java.lang.CharSequence r8 = (java.lang.CharSequence) r8     // Catch:{ Exception -> 0x0046 }
            if (r8 == 0) goto L_0x00c6
            int r8 = r8.length()     // Catch:{ Exception -> 0x0046 }
        ...
        L_0x00c6:
            ...
            au.gov.health.covidsafe.interactor.Failure r12 = new au.gov.health.covidsafe.interactor.Failure     // Catch:{ Exception -> 0x0046 }
            java.lang.Exception r0 = new java.lang.Exception     // Catch:{ Exception -> 0x0046 }
            r0.<init>()     // Catch:{ Exception -> 0x0046 }
            r12.<init>(r0)     // Catch:{ Exception -> 0x0046 }
            au.gov.health.covidsafe.interactor.Either r12 = (au.gov.health.covidsafe.interactor.Either) r12     // Catch:{ Exception -> 0x0046 }
            goto L_0x0124
        L_0x00d5:
            r0.L$0 = r11     // Catch:{ Exception -> 0x0046 }
            r0.L$1 = r5     // Catch:{ Exception -> 0x0046 }
            r0.L$2 = r6     // Catch:{ Exception -> 0x0046 }
            r0.L$3 = r12     // Catch:{ Exception -> 0x0046 }
            r0.L$4 = r2     // Catch:{ Exception -> 0x0046 }
            r0.L$5 = r7     // Catch:{ Exception -> 0x0046 }
            r0.label = r3     // Catch:{ Exception -> 0x0046 }
            java.lang.Object r12 = r11.zipAndUploadData(r7, r0)     // Catch:{ Exception -> 0x0046 }
        ...
        L_0x00ea:
            ...
            goto L_0x0124
        L_0x00ed:
            int r12 = r2.code()     // Catch:{ Exception -> 0x0046 }
        ...
        L_0x00fd:
            ...
            au.gov.health.covidsafe.interactor.Failure r12 = new au.gov.health.covidsafe.interactor.Failure     // Catch:{ Exception -> 0x0046 }
            au.gov.health.covidsafe.interactor.usecase.UploadDataException$UploadDataJwtExpiredException r0 = au.gov.health.covidsafe.interactor.usecase.UploadDataException.UploadDataJwtExpiredException.INSTANCE     // Catch:{ Exception -> 0x0046 }
            r12.<init>(r0)     // Catch:{ Exception -> 0x0046 }
            goto L_0x0117
        L_0x010d:
            au.gov.health.covidsafe.interactor.Failure r12 = new au.gov.health.covidsafe.interactor.Failure     // Catch:{ Exception -> 0x0046 }
        ...
        L_0x011a:
            ...
            r11 = r10
        L_0x011c:
            au.gov.health.covidsafe.interactor.Failure r0 = new au.gov.health.covidsafe.interactor.Failure
            r0.<init>(r12)
            r12 = r0
            au.gov.health.covidsafe.interactor.Either r12 = (au.gov.health.covidsafe.interactor.Either) r12
        L_0x0124:
        ...
        L_0x0128:
            au.gov.health.covidsafe.interactor.usecase.UploadData r11 = (au.gov.health.covidsafe.interactor.usecase.UploadData) r11
            au.gov.health.covidsafe.interactor.Failure r11 = new au.gov.health.covidsafe.interactor.Failure
            java.lang.Exception r12 = new java.lang.Exception
            r12.<init>()
            r11.<init>(r12)
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: au.gov.health.covidsafe.interactor.usecase.UploadData.run(java.lang.String, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final /* synthetic */ java.lang.Object zipAndUploadData(java.lang.String r8, kotlin.coroutines.Continuation<? super au.gov.health.covidsafe.interactor.Either<? extends java.lang.Exception, java.lang.String>> r9) {
        /*
            ...
            if (r0 == 0) goto L_0x0014
            r0 = r9
            au.gov.health.covidsafe.interactor.usecase.UploadData$zipAndUploadData$1 r0 = (au.gov.health.covidsafe.interactor.usecase.UploadData$zipAndUploadData$1) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L_0x0014
            ...
            goto L_0x0019
        L_0x0014:
            au.gov.health.covidsafe.interactor.usecase.UploadData$zipAndUploadData$1 r0 = new au.gov.health.covidsafe.interactor.usecase.UploadData$zipAndUploadData$1
            r0.<init>(r7, r9)
        L_0x0019:
        ...
        L_0x0046:
            ...
            au.gov.health.covidsafe.ui.upload.model.ExportData r9 = new au.gov.health.covidsafe.ui.upload.model.ExportData
            au.gov.health.covidsafe.streetpass.persistence.StreetPassRecordStorage r2 = new au.gov.health.covidsafe.streetpass.persistence.StreetPassRecordStorage
            au.gov.health.covidsafe.TracerApp$Companion r4 = au.gov.health.covidsafe.TracerApp.Companion
            android.content.Context r4 = r4.getAppContext()
            r2.<init>(r4)
            java.util.List r2 = r2.getAllRecords()
            r9.<init>(r2)
            ...
            r6 = 0
            okhttp3.RequestBody r5 = r5.create(r2, r6)
        ...
        L_0x00d3:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: au.gov.health.covidsafe.interactor.usecase.UploadData.zipAndUploadData(java.lang.String, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
