...
public final class OnboardingActivity extends FragmentActivity implements HasBlockingState, PagerContainer {
    ...
    public void updateProgressBar(Integer num) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(segmentedProgressBar2, str);
    ...
    public void refreshButton(UploadButtonLayout uploadButtonLayout) {
        ...
        if (uploadButtonLayout instanceof ContinueLayout) {
            ((Button) _$_findCachedViewById(R.id.onboarding_next)).setText(((ContinueLayout) uploadButtonLayout).getButtonText());
    ...
    public void onPause() {
        super.onPause();
        ((Button) _$_findCachedViewById(R.id.onboarding_next)).setOnClickListener(null);
