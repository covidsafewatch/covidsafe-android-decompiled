...
public final class UnderSixteenFragment extends PagerChildFragment {
    ...
    public void onPause() {
        super.onPause();
        ((MaterialCheckBox) _$_findCachedViewById(R.id.under_sixteen_checkbox)).setOnCheckedChangeListener(null);
    }

    public UploadButtonLayout getUploadButtonLayout() {
        return new ContinueLayout(R.string.under_sixteen_button, new UnderSixteenFragment$getUploadButtonLayout$1(this));
    }
