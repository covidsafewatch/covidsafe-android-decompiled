...
public final class PermissionExtensionsKt {
    ...
    private static final void requestFineLocationAndCheckBleSupportThenNextPermission(Fragment fragment, Function0<Unit> function0) {
        if (VERSION.SDK_INT >= 23) {
            ...
            if (activity != null) {
                ...
                EasyPermissions.requestPermissions(new Builder(fragment, (int) LOCATION, str).setRationale((int) R.string.permission_location_rationale).build());
                return;
            }
            return;
        }
    ...
    public static final void askForLocationPermission(Fragment fragment) {
        ...
        if (activity != null) {
            String str = "android.permission.ACCESS_FINE_LOCATION";
            if (!EasyPermissions.hasPermissions(activity, str)) {
                if (EasyPermissions.somePermissionPermanentlyDenied(fragment, CollectionsKt.listOf(str))) {
