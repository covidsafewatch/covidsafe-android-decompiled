...
public final class KeysetInfo extends GeneratedMessageLite<KeysetInfo, Builder> implements KeysetInfoOrBuilder {
    ...
    private ProtobufList<KeyInfo> keyInfo_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setKeyInfo(int i, Builder builder) {
        ensureKeyInfoIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addKeyInfo(Builder builder) {
        ensureKeyInfoIsMutable();
        this.keyInfo_.add(builder.build());
    }

    /* access modifiers changed from: private */
    public void addKeyInfo(int i, Builder builder) {
        ensureKeyInfoIsMutable();
