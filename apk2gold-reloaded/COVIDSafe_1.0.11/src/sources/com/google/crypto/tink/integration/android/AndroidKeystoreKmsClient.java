...
public final class AndroidKeystoreKmsClient implements KmsClient {
    ...
    public static void generateNewAeadKey(String str) throws GeneralSecurityException {
        ...
        instance.init(new Builder(validateKmsKeyUriAndRemovePrefix, 3).setKeySize(256).setBlockModes(new String[]{"GCM"}).setEncryptionPaddings(new String[]{"NoPadding"}).build());
