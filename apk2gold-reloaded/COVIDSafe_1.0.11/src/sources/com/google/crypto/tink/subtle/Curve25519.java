    ...
    static void curveMult(long[] jArr, byte[] bArr, byte[] bArr2) throws InvalidKeyException {
        ...
        while (i3 < 32) {
            ...
            while (i4 < 8) {
                ...
                swapConditional(jArr20, jArr22, i6);
                long[] jArr27 = jArr21;
                swapConditional(jArr16, jArr27, i6);
                i4 = i7 + 1;
                jArr14 = jArr27;
                jArr19 = jArr16;
                jArr18 = jArr20;
        ...
        if (!isCollinear(expand, jArr2, jArr3, jArr4)) {
            ...
            sb.append("Arithmetic error in curve multiplication with the public key: ");
            sb.append(Hex.encode(bArr2));
        ...
        if (bArr.length == 32) {
            ...
            while (true) {
                ...
                if (!Bytes.equal(bArr2[i], bArr)) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.append("Banned public key: ");
                    sb.append(Hex.encode(BANNED_PUBLIC_KEYS[i]));
