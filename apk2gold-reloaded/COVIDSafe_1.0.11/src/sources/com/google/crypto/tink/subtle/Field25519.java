...
final class Field25519 {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=long[], code=null, for r18v0, types: [long[]] */
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=long[], code=null, for r23v0, types: [long[]] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    static byte[] contract(long[] jArr) {
        ...
        for (int i13 = 2; i13 < 10; i13 += 2) {
            copyOf[i13] = copyOf[i13] - ((long) (67108863 & gte));
            int i14 = i13 + 1;
            copyOf[i14] = copyOf[i14] - j2;
        }
        for (int i15 = 0; i15 < 10; i15++) {
            copyOf[i15] = copyOf[i15] << EXPAND_SHIFT[i15];
        }
