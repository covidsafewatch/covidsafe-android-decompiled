...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    private static final class CallbackListener<V> implements Runnable {
        ...
        public void run() {
            ...
            if (future2 instanceof InternalFutureFailureAccess) {
                Throwable tryInternalFastPathGetFailure = InternalFutures.tryInternalFastPathGetFailure((InternalFutureFailureAccess) future2);
