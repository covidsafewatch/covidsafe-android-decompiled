...
public final class FeedbackModule {
    ...
    public static void init(Application application) {
        if (feedbackClient == null) {
            ...
            FeedbackClient feedbackClient2 = new FeedbackClient(new JmcRestClient(), new DeviceInfo(application.getApplicationContext()), jobQueue, androidUiNotifier, activityTracker, new FeedbackSettings(application.getSharedPreferences(STORE_NAME, 0)));
