...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    LinkedHashTreeMap(java.util.Comparator r2) {
        ...
        L_0x000d:
            r1.comparator = r2
            com.airbnb.lottie.parser.moshi.LinkedHashTreeMap$Node r2 = new com.airbnb.lottie.parser.moshi.LinkedHashTreeMap$Node
            r2.<init>()
            r1.header = r2
            r2 = 16
            com.airbnb.lottie.parser.moshi.LinkedHashTreeMap$Node[] r2 = new com.airbnb.lottie.parser.moshi.LinkedHashTreeMap.Node[r2]
            r1.table = r2
            int r0 = r2.length
            int r0 = r0 / 2
            int r2 = r2.length
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.moshi.LinkedHashTreeMap.<init>(java.util.Comparator):void");
    }
