...
final class ProgressButtonHolder implements LifecycleEventObserver {
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Event event) {
        ...
        if (event == Event.ON_DESTROY) {
            TextView textView2 = (TextView) this.textView.get();
            if (textView2 != null) {
                ...
                TextChangeAnimatorParams textChangeAnimatorParams = (TextChangeAnimatorParams) ProgressButtonHolderKt.getAttachedViews().remove(textView2);
            }
        }
    }
}
