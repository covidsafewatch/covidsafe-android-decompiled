...
public final class Dispatcher {
    ...
    public final synchronized ExecutorService executorService() {
        ...
        if (this.executorServiceOrNull == null) {
            ...
            ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, timeUnit, synchronousQueue, Util.threadFactory(sb.toString(), false));
    ...
    private final AsyncCall findExistingCallWithHost(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (Intrinsics.areEqual((Object) asyncCall.getHost(), (Object) str)) {
                return asyncCall;
            }
        }
        Iterator it2 = this.readyAsyncCalls.iterator();
        while (it2.hasNext()) {
            AsyncCall asyncCall2 = (AsyncCall) it2.next();
            if (Intrinsics.areEqual((Object) asyncCall2.getHost(), (Object) str)) {
                return asyncCall2;
            }
        }
        return null;
    ...
    public final synchronized void cancelAll() {
        ...
        while (it.hasNext()) {
            ((AsyncCall) it.next()).getCall().cancel();
        }
        Iterator it2 = this.runningAsyncCalls.iterator();
        while (it2.hasNext()) {
            ((AsyncCall) it2.next()).getCall().cancel();
        }
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        Iterable<AsyncCall> iterable = this.readyAsyncCalls;
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterable, 10));
        for (AsyncCall call : iterable) {
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        Iterable<AsyncCall> iterable = this.runningAsyncCalls;
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterable, 10));
        for (AsyncCall call : iterable) {
            arrayList.add(call.getCall());
        }
        unmodifiableList = Collections.unmodifiableList(CollectionsKt.plus(collection, (Iterable<? extends T>) (List) arrayList));
        Intrinsics.checkExpressionValueIsNotNull(unmodifiableList, "Collections.unmodifiable…yncCalls.map { it.call })");
        return unmodifiableList;
    }
