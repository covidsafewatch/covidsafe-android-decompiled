...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public final boolean domainMatch(String str, String str2) {
            ...
            if (!StringsKt.endsWith$default(str, str2, false, 2, null) || str.charAt((str.length() - str2.length()) - 1) != '.' || Util.canParseAsIpAddress(str)) {
                z = false;
            }
            return z;
        }
        ...
        public final okhttp3.Cookie parse$okhttp(long r25, okhttp3.HttpUrl r27, java.lang.String r28) {
            /*
                ...
                r5 = 0
                r0 = r28
                int r8 = okhttp3.internal.Util.delimiterOffset$default(r0, r1, r2, r3, r4, r5)
                r1 = 61
                r4 = 2
                r3 = r8
                int r0 = okhttp3.internal.Util.delimiterOffset$default(r0, r1, r2, r3, r4, r5)
                r1 = 0
            ...
            L_0x0069:
                ...
                r9 = 59
                int r9 = okhttp3.internal.Util.delimiterOffset(r6, r9, r8, r4)
                r1 = 61
                int r1 = okhttp3.internal.Util.delimiterOffset(r6, r1, r8, r9)
        ...
        private final long parseExpires(String str, int i, int i2) {
            ...
            while (dateCharacterOffset < i3) {
                ...
                if (i5 == -1 && matcher.usePattern(Cookie.TIME_PATTERN).matches()) {
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(group4, str3);
        ...
        private final String parseDomain(String str) {
            String str2 = ".";
            if (!StringsKt.endsWith$default(str, str2, false, 2, null)) {
                String canonicalHost = HostnamesKt.toCanonicalHost(StringsKt.removePrefix(str, (CharSequence) str2));
                if (canonicalHost != null) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Cookie) {
            ...
            if (Intrinsics.areEqual((Object) cookie.name, (Object) this.name) && Intrinsics.areEqual((Object) cookie.value, (Object) this.value) && cookie.expiresAt == this.expiresAt && Intrinsics.areEqual((Object) cookie.domain, (Object) this.domain) && Intrinsics.areEqual((Object) cookie.path, (Object) this.path) && cookie.secure == this.secure && cookie.httpOnly == this.httpOnly && cookie.persistent == this.persistent && cookie.hostOnly == this.hostOnly) {
                return true;
            }
        }
        return false;
