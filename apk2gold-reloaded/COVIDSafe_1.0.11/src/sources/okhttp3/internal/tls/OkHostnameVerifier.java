...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String str, String str2) {
        ...
        if (!(charSequence == null || charSequence.length() == 0)) {
            String str5 = ".";
            if (!StringsKt.startsWith$default(str3, str5, false, 2, null)) {
                String str6 = "..";
                if (!StringsKt.endsWith$default(str3, str6, false, 2, null)) {
                    CharSequence charSequence2 = str4;
                    if (!(charSequence2 == null || charSequence2.length() == 0) && !StringsKt.startsWith$default(str4, str5, false, 2, null) && !StringsKt.endsWith$default(str4, str6, false, 2, null)) {
                        if (!StringsKt.endsWith$default(str3, str5, false, 2, null)) {
                            StringBuilder sb = new StringBuilder();
                            sb.append(str3);
                            sb.append(str5);
                            str3 = sb.toString();
                        }
                        if (!StringsKt.endsWith$default(str4, str5, false, 2, null)) {
                        ...
                        if (str4 != null) {
                            ...
                            String str8 = "*.";
                            if (!StringsKt.startsWith$default(lowerCase, str8, false, 2, null) || StringsKt.indexOf$default(charSequence3, '*', 1, false, 4, (Object) null) != -1 || str3.length() < lowerCase.length() || Intrinsics.areEqual((Object) str8, (Object) lowerCase)) {
                                return false;
                            }
                            if (lowerCase != null) {
                                String substring = lowerCase.substring(1);
                                Intrinsics.checkExpressionValueIsNotNull(substring, "(this as java.lang.String).substring(startIndex)");
                                if (!StringsKt.endsWith$default(str3, substring, false, 2, null)) {
                                    return false;
                                }
    ...
    public final List<String> allSubjectAltNames(X509Certificate x509Certificate) {
        Intrinsics.checkParameterIsNotNull(x509Certificate, "certificate");
        return CollectionsKt.plus((Collection<? extends T>) getSubjectAltNames(x509Certificate, 7), (Iterable<? extends T>) getSubjectAltNames(x509Certificate, 2));
    }
    ...
    private final List<String> getSubjectAltNames(X509Certificate x509Certificate, int i) {
        try {
            ...
            for (List list : subjectAlternativeNames) {
                if (list != null) {
                    if (list.size() >= 2) {
                        if (!(!Intrinsics.areEqual(list.get(0), (Object) Integer.valueOf(i)))) {
