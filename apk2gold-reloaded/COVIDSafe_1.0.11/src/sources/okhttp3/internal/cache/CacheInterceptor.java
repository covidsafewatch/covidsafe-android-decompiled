...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!StringsKt.equals(HttpHeaders.WARNING, name, true) || !StringsKt.startsWith$default(value, DiskLruCache.VERSION_1, false, 2, null)) {
        ...
        private final boolean isEndToEnd(String str) {
            if (StringsKt.equals(HttpHeaders.CONNECTION, str, true) || StringsKt.equals("Keep-Alive", str, true) || StringsKt.equals(HttpHeaders.PROXY_AUTHENTICATE, str, true) || StringsKt.equals(HttpHeaders.PROXY_AUTHORIZATION, str, true) || StringsKt.equals(HttpHeaders.TE, str, true) || StringsKt.equals("Trailers", str, true) || StringsKt.equals(HttpHeaders.TRANSFER_ENCODING, str, true) || StringsKt.equals(HttpHeaders.UPGRADE, str, true)) {
                return false;
            }
            return true;
        }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        CacheStrategy compute = new Factory(System.currentTimeMillis(), chain.request(), response).compute();
    ...
    private final Response cacheWritingResponse(CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, HttpHeaders.CONTENT_TYPE, null, 2, null), response.body().contentLength(), Okio.buffer((Source) cacheInterceptor$cacheWritingResponse$cacheWritingSource$1))).build();
    }
}
