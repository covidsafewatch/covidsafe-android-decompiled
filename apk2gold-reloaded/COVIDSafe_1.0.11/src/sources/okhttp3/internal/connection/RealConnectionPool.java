...
public final class RealConnectionPool {
    ...
    public RealConnectionPool(TaskRunner taskRunner, int i, long j, TimeUnit timeUnit) {
        ...
        this.cleanupTask = new RealConnectionPool$cleanupTask$1(this, sb.toString());
        if (!(j > 0)) {
    ...
    private final int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < calls.size()) {
            ...
            if (reference.get() != null) {
                ...
                CallReference callReference = (CallReference) reference;
                StringBuilder sb = new StringBuilder();
                ...
                Platform.Companion.get().logCloseableLeak(sb.toString(), callReference.getCallStackTrace());
                calls.remove(i);
                realConnection.setNoNewExchanges(true);
                if (calls.isEmpty()) {
