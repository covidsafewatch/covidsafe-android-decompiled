...
public final class ExchangeFinder {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x004f, code lost:
        if (r6.supportsUrl(r1.address.url()) == false) goto L_0x0051;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:56:0x00e2, code lost:
        if (r4.hasNext() == false) goto L_0x00e4;
     */
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0061  */
    /* JADX WARNING: Removed duplicated region for block: B:24:0x0070  */
    /* JADX WARNING: Removed duplicated region for block: B:64:0x0110 A[SYNTHETIC] */
    ...
    private final boolean retryCurrentRoute() {
        ...
        RealConnection connection = this.call.getConnection();
        if (connection == null || connection.getRouteFailureCount$okhttp() != 0 || !Util.canReuseConnectionFor(connection.route().address().url(), this.address.url())) {
            return false;
        }
        return true;
    }
