...
public final class RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1 extends Task {
    ...
    final /* synthetic */ ObjectRef $messageOrClose$inlined;
    final /* synthetic */ String $name;
    final /* synthetic */ ByteString $pong$inlined;
    final /* synthetic */ IntRef $receivedCloseCode$inlined;
    final /* synthetic */ ObjectRef $receivedCloseReason$inlined;
    final /* synthetic */ ObjectRef $streamsToClose$inlined;
    final /* synthetic */ WebSocketWriter $writer$inlined;
    final /* synthetic */ RealWebSocket this$0;

    public RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1(String str, boolean z, String str2, boolean z2, RealWebSocket realWebSocket, WebSocketWriter webSocketWriter, ByteString byteString, ObjectRef objectRef, IntRef intRef, ObjectRef objectRef2, ObjectRef objectRef3) {
        this.$name = str;
        this.$cancelable = z;
