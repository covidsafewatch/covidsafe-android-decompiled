...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public final void connect(OkHttpClient okHttpClient) {
        ...
        Request build2 = newBuilder.header(str, "websocket").header(HttpHeaders.CONNECTION, str).header(HttpHeaders.SEC_WEBSOCKET_KEY, this.key).header(HttpHeaders.SEC_WEBSOCKET_VERSION, "13").build();
    ...
    public final void initReaderAndWriter(String str, Streams streams2) throws IOException {
        ...
        synchronized (this) {
            ...
            if (this.pingIntervalMillis != 0) {
                ...
                RealWebSocket$initReaderAndWriter$$inlined$synchronized$lambda$1 realWebSocket$initReaderAndWriter$$inlined$synchronized$lambda$1 = new RealWebSocket$initReaderAndWriter$$inlined$synchronized$lambda$1(sb2, sb2, nanos, this, str, streams2);
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        ...
        L_0x00f6:
            ...
            okio.BufferedSink r0 = okio.Okio.buffer(r0)     // Catch:{ all -> 0x018f }
            r0.write(r2)     // Catch:{ all -> 0x018f }
