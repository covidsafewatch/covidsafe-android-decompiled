...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final Builder readHttp2HeadersList(Headers headers, Protocol protocol) {
    ...
    public Builder readResponseHeaders(boolean z) {
        ...
        Builder readHttp2HeadersList = Companion.readHttp2HeadersList(http2Stream.takeHeaders(), this.protocol);
