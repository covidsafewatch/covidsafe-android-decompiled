...
public final class Android10Platform extends Platform {
    ...
    public static final boolean isSupported = (AndroidPlatform.Companion.isAndroid() && VERSION.SDK_INT >= 29);
    ...
    public Android10Platform() {
        Iterable listOfNotNull = CollectionsKt.listOfNotNull((T[]) new SocketAdapter[]{Android10SocketAdapter.Companion.buildIfSupported(), ConscryptSocketAdapter.Companion.buildIfSupported(), new DeferredSocketAdapter("com.google.android.gms.org.conscrypt")});
