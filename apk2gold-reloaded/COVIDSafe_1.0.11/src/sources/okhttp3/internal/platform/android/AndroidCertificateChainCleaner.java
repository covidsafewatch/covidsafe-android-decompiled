    ...
    public static final class Companion {
        ...
        public final AndroidCertificateChainCleaner build(X509TrustManager x509TrustManager) {
            ...
            try {
                ...
                Method method = cls.getMethod(str, new Class[]{X509Certificate[].class, String.class, String.class});
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        try {
            ...
            if (array != null) {
                ...
                Object invoke = this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, new Object[]{x509CertificateArr, "RSA", str});
                if (invoke != null) {
                    return (List) invoke;
                }
