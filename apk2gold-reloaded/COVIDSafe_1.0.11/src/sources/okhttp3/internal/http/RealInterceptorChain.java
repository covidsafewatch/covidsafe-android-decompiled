...
public final class RealInterceptorChain implements Chain {
    ...
    public final RealInterceptorChain copy$okhttp(int i, Exchange exchange2, Request request2, int i2, int i3, int i4) {
        Request request3 = request2;
        Intrinsics.checkParameterIsNotNull(request2, "request");
        RealInterceptorChain realInterceptorChain = new RealInterceptorChain(this.call, this.interceptors, i, exchange2, request3, i2, i3, i4);
            ...
            if (exchange2 != null) {
                if (exchange2.getConnection$okhttp().supportsUrl(request2.url())) {
                    if (!(this.calls == 1)) {
                        ...
                        sb.append(str2);
                        sb.append((Interceptor) this.interceptors.get(this.index - 1));
                        sb.append(str);
                    ...
                    sb2.append(str2);
                    sb2.append((Interceptor) this.interceptors.get(this.index - 1));
