            ...
            if (awaitTaskToRun != null) {
                ...
                try {
                    ...
                    if (isLoggable) {
                        ...
                        TaskLoggerKt.log(awaitTaskToRun, queue$okhttp, sb.toString());
                    }
                } catch (Throwable th) {
                    if (isLoggable) {
                        ...
                        sb2.append(TaskLoggerKt.formatDuration(nanoTime2));
                        TaskLoggerKt.log(awaitTaskToRun, queue$okhttp, sb2.toString());
                    }
                    throw th;
                }
            } else {
