...
public final class Cache implements Closeable, Flushable {
    ...
    private final class RealCacheRequest implements CacheRequest {
        ...
        public void abort() {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r4.done     // Catch:{ all -> 0x0024 }
                if (r1 == 0) goto L_0x0009
                monitor-exit(r0)
                return
            L_0x0009:
                r1 = 1
                r4.done = r1     // Catch:{ all -> 0x0024 }
                okhttp3.Cache r2 = r4.this$0     // Catch:{ all -> 0x0024 }
                int r3 = r2.getWriteAbortCount$okhttp()     // Catch:{ all -> 0x0024 }
                int r3 = r3 + r1
                r2.setWriteAbortCount$okhttp(r3)     // Catch:{ all -> 0x0024 }
                monitor-exit(r0)
                okio.Sink r0 = r4.cacheOut
                java.io.Closeable r0 = (java.io.Closeable) r0
                okhttp3.internal.Util.closeQuietly(r0)
                okhttp3.internal.cache.DiskLruCache$Editor r0 = r4.editor     // Catch:{ IOException -> 0x0023 }
                r0.abort()     // Catch:{ IOException -> 0x0023 }
            L_0x0023:
                return
            L_0x0024:
                r1 = move-exception
    ...
    public final void update$okhttp(Response response, Response response2) {
        ...
        if (body != null) {
            try {
                Editor edit = ((CacheResponseBody) body).getSnapshot$okhttp().edit();
                if (edit != null) {
                    entry.writeTo(edit);
                    edit.commit();
                }
