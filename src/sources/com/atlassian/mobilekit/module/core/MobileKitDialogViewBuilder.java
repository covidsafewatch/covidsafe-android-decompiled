...
public class MobileKitDialogViewBuilder {
    ...
    public MobileKitDialogViewBuilder positiveButton(int i, View.OnClickListener onClickListener) {
        this.posBtnResId = i;
        this.posClickListener = onClickListener;
        return this;
    }

    public MobileKitDialogViewBuilder negativeButton(int i, View.OnClickListener onClickListener) {
        this.negBtnResId = i;
