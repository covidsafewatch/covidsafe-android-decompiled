...
public final class KmsEnvelopeAeadKeyFormat extends GeneratedMessageLite<KmsEnvelopeAeadKeyFormat, Builder> implements KmsEnvelopeAeadKeyFormatOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setDekTemplate(KeyTemplate.Builder builder) {
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                KeyTemplate.Builder builder = this.dekTemplate_ != null ? (KeyTemplate.Builder) this.dekTemplate_.toBuilder() : null;
