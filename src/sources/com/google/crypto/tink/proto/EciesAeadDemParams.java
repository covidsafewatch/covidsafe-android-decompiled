...
public final class EciesAeadDemParams extends GeneratedMessageLite<EciesAeadDemParams, Builder> implements EciesAeadDemParamsOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setAeadDem(KeyTemplate.Builder builder) {
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        if (this.aeadDem_ != null) {
            i2 = 0 + CodedOutputStream.computeMessageSize(2, getAeadDem());
        }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
            ...
            case 5:
                this.aeadDem_ = (KeyTemplate) ((GeneratedMessageLite.Visitor) obj).visitMessage(this.aeadDem_, ((EciesAeadDemParams) obj2).aeadDem_);
            ...
            case 6:
                ...
                while (!z) {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 18) {
                                KeyTemplate.Builder builder = this.aeadDem_ != null ? (KeyTemplate.Builder) this.aeadDem_.toBuilder() : null;
    ...
    static {
        ...
        eciesAeadDemParams.makeImmutable();
    }
