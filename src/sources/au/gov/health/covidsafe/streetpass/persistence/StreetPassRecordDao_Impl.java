...
public final class StreetPassRecordDao_Impl implements StreetPassRecordDao {
    ...
    public LiveData<StreetPassRecord> getMostRecentRecord() {
        ...
        return this.__db.getInvalidationTracker().createLiveData(new String[]{"record_table"}, false, new Callable<StreetPassRecord>() {
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v0, resolved type: au.gov.health.covidsafe.streetpass.persistence.StreetPassRecord} */
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v1, resolved type: au.gov.health.covidsafe.streetpass.persistence.StreetPassRecord} */
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: au.gov.health.covidsafe.streetpass.persistence.StreetPassRecord} */
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r20v0, resolved type: java.lang.Integer} */
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v5, resolved type: au.gov.health.covidsafe.streetpass.persistence.StreetPassRecord} */
            /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v1, resolved type: au.gov.health.covidsafe.streetpass.persistence.StreetPassRecord} */
