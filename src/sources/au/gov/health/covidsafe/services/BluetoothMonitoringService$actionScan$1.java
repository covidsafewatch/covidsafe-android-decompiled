...
final class BluetoothMonitoringService$actionScan$1 extends Lambda implements Function1<BroadcastMessageResponse, Unit> {
    final /* synthetic */ BluetoothMonitoringService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BluetoothMonitoringService$actionScan$1(BluetoothMonitoringService bluetoothMonitoringService) {
        super(1);
    ...
    public final void invoke(BroadcastMessageResponse broadcastMessageResponse) {
        ...
        this.this$0.performScanAndScheduleNextScan();
    }
}
