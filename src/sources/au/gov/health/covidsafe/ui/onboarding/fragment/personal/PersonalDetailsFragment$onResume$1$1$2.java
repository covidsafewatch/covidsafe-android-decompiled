...
final class PersonalDetailsFragment$onResume$1$1$2 implements NumberPicker.OnValueChangeListener {
    final /* synthetic */ Ref.IntRef $selected;

    PersonalDetailsFragment$onResume$1$1$2(Ref.IntRef intRef) {
