...
final class OnboardingActivity$refreshButton$1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        Function0<Unit> buttonListener = ((UploadButtonLayout.ContinueLayout) this.$updateButtonLayout).getButtonListener();
