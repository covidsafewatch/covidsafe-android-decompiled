...
final class EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$1 extends Lambda implements Function1<OTPChallengeResponse, Unit> {
    ...
    EnterNumberPresenter$makeOTPCall$$inlined$let$lambda$1(EnterNumberPresenter enterNumberPresenter, int i, String str) {
        super(1);
    ...
    public final void invoke(OTPChallengeResponse oTPChallengeResponse) {
        ...
        this.this$0.enterNumberFragment.navigateToOTPPage(oTPChallengeResponse.getSession(), oTPChallengeResponse.getChallengeName(), this.$callingCode$inlined, this.$phoneNumber$inlined);
    }
}
